...
,`Text0_1_loc9`='Which profession?'



Text0_1_loc9`='Yeah? Whadya'

,`Text0_1_loc9`='I am new to the burdens of leadership. I should\'ve seen Narkrall\'s insubordination coming. Instead I am cleaning up his mess.$B$BI don\'t know how Garrosh Hellscream does it. He must possess great strength to hold together a force as diverse as the Horde... I should like to know him more.'

,`Text0_1_loc9`='Welcome, $C.$B$BHyjal burns and the world I\'ve spent my life protecting is on the brink of oblivion.$B$BTell me: Have you ever heard of Tyrus Blackhorn?'


,`Text0_1_loc9`='Welcome to my Inn, weary traveler. What can I do for you?'

,`Text0_1_loc9`='We\'ve long held out hope of redeeming the Earthwarden and his children. At some point, we must have the wisdom to realize that no amount of redemption can atone for the destruction these dragons are unleashing upon the world.$B$BAt some point, we are forced to intervene.'
,`Text1_0_loc9`='We are poorly equipped to do battle here.$B$BPreparations must be made...'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='What? I don\'t know of any warlock trainers in Stormwind. $B$BAlthough... There have been some sightings of demonic activity over by The Slaughtered Lamb in the Mage Quarter. I suppose you could check there.',`Text1_0_loc9`='Warlocks, eh. Well, you didn\'t hear it from me, but I\'ve heard rumors that those types gather at a bar called the Slaughtered Lamb in the Mage Quarter.',`Text1_1_loc9`='Warlocks, eh. Well, you didn\'t hear it from me, but I\'ve heard rumors that those types gather at a bar called the Slaughtered Lamb in the Mage Quarter.' WHERE `entry`=906;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='If you are looking to become a great cook, venture over to the Pig and Whistle Tavern in Old Town and talk to Stephen Ryback. That man knows how to cook up a rack of ribs like no other.$B$BMan... now you got me hungry for some of his famous ribs. Don\'t count on him teaching you that recipe though!',`Text1_0_loc9`='There\'s a great cook who works at the Pig and Whistle Tavern in Old Town. I\'ve watched him use a knife when he cooks and just between you and me, I don\'t think he\'s always been a cook. Don\'t get me wrong... if you still want to learn, he\'s the best we have.',`Text1_1_loc9`='There\'s a great cook who works at the Pig and Whistle Tavern in Old Town. I\'ve watched him use a knife when he cooks and just between you and me, I don\'t think he\'s always been a cook. Don\'t get me wrong... if you still want to learn, he\'s the best we have.' WHERE `entry`=921;
...
,`Text0_1_loc9`='Master Pyreanor can be found among Thrall\'s advisors in his fortress, Grommash Hold, in the Valley of Wisdom.'
...
UPDATE `locales_npc_text` SET ,`Text1_0_loc9`='Be sure to taste the Dark Iron ale. Local dwarves are said to whip him nonstop.' WHERE `entry`=2727;

,`Text0_1_loc9`='Good idea!'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Thanks again, $N. Rocknot and I are really hitting it off!',`Text1_0_loc9`='Welcome to the sullen glutton tavern!' WHERE `entry`=2729;
UPDATE `locales_npc_text` SET `Text0_1_loc9`='Thanks again, $N. Rocknot and I are really hitting it off!', `Text1_0_loc9`='Welcome to the sullen glutton tavern!',, `Text1_1_loc9`='Welcome to the Grim Guzzler!' WHERE `entry`=2729;
UPDATE `locales_npc_text` SET ,`Text3_0_loc9`='"My Mr. Shtoppor Nalivals is a good boss. In addition, he earns a lot. His pockets just pop at the seams!"' WHERE `entry`=2729;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Do ye have some new treasures that ye want to keep safe n\' sound?  Ye\'ll be wanting to store them at The Vault with the Stonemantles. Ye\'ll find The Vault just a hammer\'s throw northeast from the entrance to Ironforge.',`Text1_0_loc9`='The bank?  Oh, ye mean The Vault!  No safer place to store yer valuables than The Vault. Ye\'ll find it just northeast of the entrance to Ironforge.',`Text1_1_loc9`='The bank?  Oh, ye mean The Vault!  No safer place to store yer valuables than The Vault. Ye\'ll find it just northeast of the entrance to Ironforge.' WHERE `entry`=2761;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Ah, nothing quite like a ride on a gryphon, is there?  The night elves can keep those hippo\'s of theirs, just give me a gryphon and the wind in me hair!  $B$BWell now, I won\'t keep ye any longer, just head over to Gryth Thurden on the east side of The Great Forge and he\'ll get ye on yer way.',`Text1_0_loc9`='Ah, nothing quite like a ride on a gryphon, is there?  The night elves can keep those hippo\'s of theirs, just give me a gryphon and the wind in me hair!  $B$BWell now, I won\'t keep ye any longer, just head over to Gryth Thurden on the east side of The Great Forge and he\'ll get ye on yer way.',`Text1_1_loc9`='Ah, nothing quite like a ride on a gryphon, is there?  The night elves can keep those hippo\'s of theirs, just give me a gryphon and the wind in me hair!  $B$BWell now, I won\'t keep ye any longer, just head over to Gryth Thurden on the east side of The Great Forge and he\'ll get ye on yer way.' WHERE `entry`=2762;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='That wee wizardly lass, Bink, over in the Hall of Mysteries would probably be able to help ye out with any magical needs you have.$B$BThe Hall of Mysteries is just north of the gates of Ironforge.',`Text1_0_loc9`='Well ye\'d be sure to find some training in the magical arts over in the Hall of Mysteries, north of the gates of Ironforge. Juli Stormkettle can always be found there with her nose in a book.',`Text1_1_loc9`='Well ye\'d be sure to find some training in the magical arts over in the Hall of Mysteries, north of the gates of Ironforge. Juli Stormkettle can always be found there with her nose in a book.' WHERE `entry`=2771;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Ah, Braenna Flintcrag. She has magic hands, that one. Braenna is the one to see about Priestly matters. $B$BYe\'ll want to travel north from the gates of Ironforge to the Hall of Mysteries. That\'s where ye\'ll find her.',`Text1_0_loc9`='Ah, nothing better than a priest to cure what ails ye. Of course a nice tall pint cures a lot of what ails ye too, but I don\'t think Braenna Flintcrag teaches brewing. I guess ye\'ll have to settle for some priest training over in the Hall of Mysteries instead.',`Text1_1_loc9`='Ah, nothing better than a priest to cure what ails ye. Of course a nice tall pint cures a lot of what ails ye too, but I don\'t think Braenna Flintcrag teaches brewing. I guess ye\'ll have to settle for some priest training over in the Hall of Mysteries instead.' WHERE `entry`=2772;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Time is running out for me... for us all...',`Text1_0_loc9`='I\'m sad to see that the furbolgs could have been corrupted so easily, before they were our friends.',`Text1_1_loc9`='I have so much to do... so much before the plague comes...' WHERE `entry`=3668;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='John, honey, where are you?',`Text3_0_loc9`='What happened? I\'m so ... cold ...',`Text3_1_loc9`='What is happening to everyone?  I feel... cold...' WHERE `entry`=3668;
...
,`Text1_0_loc9`='"It\'s a great honor to see you again,$N."'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='"Perfectly. Just great. $N, you are an example to all of us."',`Text1_0_loc9`='"I really envy you,$N. You performed$G: performed; the work is just awesome."',`Text1_1_loc9`='"I really envy you,$N. You performed$G: performed; the work is just awesome."' WHERE `entry`=5940;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Never look the Commander directly in the eyes.',`Text1_0_loc9`='"We have Cairn\'s order, | 3-6 ($R). Do not stop us from completing the commander\'s mission."',`Text1_1_loc9`='We are under direct orders from Cairne, $R. Do not interfere with the Commander\'s task.' WHERE `entry`=6105;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='The Shaman Commander is not to be trifled with, $R.',`Text3_0_loc9`='Lokolar will come soon ... Soon ... Very soon ...',`Text3_1_loc9`='Soon, Lokholar shall rise... Soon... Very, very soon...' WHERE `entry`=6105;
...
,`Text0_1_loc9`='Seek out Shandrina in Silverwind Refuge. She can sell you the Expert Cookbook.'
...
,`Text0_1_loc9`='Praise the Light, one has finally answered the calling.'
,`Text0_1_loc9`='<Eris nods.>$B$BThe Eye has seen so many horrors and so many wonders.$B$BIt displays what it feels the one looking into it is most suited to see.'
,`Text0_1_loc9`='You were. The Eye is never wrong.$B$BYou are a $G priest:priestess;, after all. A powerful $G priest:priestess;, if the Eye showed you this horrible memory.$B$BYou have come for redemption, yet you yourself do not even realize this... Do you?'
,`Text0_1_loc9`='I know you will, $N.$B$BI myself am a priestess, though, unlike you I am long since gone from this world. My spirit, however, remains here, as do the spirits of the thousands who were brutally slain by the mad Prince, Arthas Menethil and his legion of undeath.'
,`Text0_1_loc9`='I never stated that you were here to redeem yourself, $G priest:priestess;. You are here to redeem me and the innocents murdered while trying to escape Stratholme.$BMy spirit and the spirit of those lost are bound here, cursed to endlessly relive our own tragic deaths.'
,`Text0_1_loc9`='You must do what I could not: Save the peasants that were cut down while fleeing from Stratholme.$B$BThey will walk towards the light, you must ensure their survival. Should too many fall, our cursed existence shall continue - you will have failed.$B$BEvery ability, prayer, and spell that you have learned will be tested. May the Light protect you, $N.'
...
,`Text0_1_loc9`='I will teach you the way of the hammersmith. Just ask nicely.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Every item that I have for sale I acquired myself. You have my personal guarantee of authenticity.',`Text1_0_loc9`='Darkmoon Cards? This is to the professor. And I deal with antiquities and artifacts.',`Text1_1_loc9`='Darkmoon Faire Cards?  See the Professor here for those. Come see me if you are a dealer in hard to come by antiquities and artifacts.' WHERE `entry`=7389;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Come and take a look at my wares while you still can. We\'re here all week, and then we\'re off to some far off land.',`Text3_0_loc9`='Do you have any idea what I had to go through to bring these incomparable values ​​for sale ?! Look at them yourself!',`Text3_1_loc9`='Have you any idea what I go through to bring these incomparable valuables to sell?  Come see them all for yourself!' WHERE `entry`=7389;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Tasty drinks for sale!  Quench your thirst on some of the Darkmoon Faire\'s finest brews!',`Text1_0_loc9`='"Do not be shy, buy everyone a cup!"',`Text1_1_loc9`='Don\'t be shy, buy a round for everyone!' WHERE `entry`=7404;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Tips are always graciously accepted, friend.',`Text3_0_loc9`='"Only here! ""Special New Moon"", just cooked! Disassemble before everyone has drunk!"',`Text3_1_loc9`='Just in... another batch of Darkmoon Special Reserve. Come get yours before they\'re all gone!' WHERE `entry`=7404;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Elune be praised!  You seek out our Warsong Gulch Battlemaster?  Her name is Aethalas, and she stands ready to greet you near the warrior trainers.',`Text1_0_loc9`='"You take on a tough job,$N. To get into the War Song Gorge, you need to speak with Etalas, the commander of Silverwing Sentinels. She will tell you where to go. May the blessing of the Goddess be with you!"',`Text1_1_loc9`='It is no light endeavor upon which you embark $N. To get to Warsong Gulch you will want to speak to Aethalas, the Battlemaster of the Silverwing Sentinels. She will guide your way. Blessings of the Goddess be with you!' WHERE `entry`=7482;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='The humans definitely need all of our help in Arathi Basin. The one that you wish to speak to is named Keras Wolfheart. He stands ready to assist you on the Warrior\'s Terrace.',`Text1_0_loc9`='"If you really want it, | 3-6 ($C), find Keras Wulfhart on the Warrior Terrace. He is a representative of the Arathor League. He can help you get to the Arathi Basin."',`Text1_1_loc9`='If that is your wish $C, then you will need to speak to Keras Wolfheart on the Warrior\'s Terrace. He is a representative of The League of Arathor and can help you to get to Arathi Basin.' WHERE `entry`=7651;
...
Text0_1_loc9`='Fishmaster Bassbait has had the waters here seeded with high quality Tastyfish so he can have his tournament.$B$BOnce he gets his winner, I will give you silver for each five Tastyfish you bring me!'
...
,`Text0_1_loc9`='No luck with the Twilight\'s Hammer deserter?  Check the mountains to the southeast thoroughly. There are numerous rumors of a mysterious hermit living there.'
...
,`Text0_1_loc9`='"A thundering voice is heard from the stone ...$B$BI can feel your status medallion, cultist, but you don\'t have a ring of power? Are you the real Twilight\'s Hammer commander, or are you just running errands for your senior?"'
...
,`Text0_1_loc9`='"The Janis Barova diary is full of bombastic and rambling records of undead. Toward the end of the book, there is something similar to a pattern of a bag made of fel cloth. Warlocks store soul stones in these bags. Want to copy a pattern to your diary?"'
,`Text0_1_loc9`='"The diary of Janis Barova is filled with all sorts of thoughts and thoughts on the subject of undead. Toward the end of the notebook, a pattern of a bag made of fel cloth is found. Warlocks store soul stones in these bags. You already know how to sew such a bag."'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Mighty fine weather we\'re having here, wouldn\'t you say?',`Text1_0_loc9`='"Well, why, when you need a gyroscope, you can\'t always find it ?!"',`Text1_1_loc9`='Why is it that there\'s never a gyrochronatom lying around when you need one?' WHERE `entry`=8143;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='I\'ll get the last laugh... they\'ll see! Oh, hi $C, I didn\'t see you there.',`Text3_0_loc9`='"$GMy dear: My dear: c; | 3-6 ($C)! Two percent of inventions are made on a drunken bench, four after a sunstroke, six more are like thunder from a clear sky, and the remaining ninety-three percent belong to Rumpelshniker."',`Text3_1_loc9`='Invention, my dear $C, is two percent bottled inspiration, four percent solar exposure, six percent chance of thunderstorms clearing by mid-afternoon, and ninety-three percent Rumplesnicker.$B$BWait, did that add to one hundred? I\'ve got my notes around here somewhere.' WHERE `entry`=8143;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Elune be with you, $C.',`Text1_0_loc9`='The High Priestess could not leave Darnassus. Fandral is very angry.',`Text1_1_loc9`='The High Priestess could not leave Darnassus. Fandral is in a very foul mood.' WHERE `entry`=8164;
...
,`Text0_1_loc9`='Can\'t you see that I\'m trying to have a conversation with the lady?  Oh, very well, she seems preoccupied anyway.$B$BI deal in only the finest drinks, both local and exotic in vintage. Care to have a look?'
...
,`Text0_1_loc9`='One set of trolls dealt with, one yet to go. You have no idea how much I appreciate what you\'re doing, $N! Before you came along I didn\'t think we\'d ever get the Shadowpine problem under control.'
...
,`Text0_1_loc9`='You don\'t see too many apprentices around these parts, do you?  I\'m beginning to think it\'s because the magisters give us all the dangerous work they\'d rather not do themselves.'
...
,`Text0_1_loc9`='OY! Wait in line, would ya? Outland food doesn\'t agree with me at all.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='My job consists of one task and one task only: ensuring that the West Sanctum runs smoothly.$B$BYou\'ll have to excuse my temper but, as you can see, the situation here is a bit out of hand.',`Text1_0_loc9`='"Are the night elves behind all this? Although unlikely. With such a burden for the Western Sanctuary, sooner or later some kind of trouble would surely happen."',`Text1_1_loc9`='Could night elf saboteurs be behind this?  I doubt it. With the load we\'ve been putting on the West Sanctum it was only a matter of time until something went wrong.' WHERE `entry`=8700;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Ugh... go away!',`Text1_0_loc9`='Huh, what?  What happened?',`Text1_1_loc9`='Huh, what?  What happened?' WHERE `entry`=8761;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Go away.. I\'m tryin\' to shleep here.',`Text3_0_loc9`='Ack, I don\'t feel so good.',`Text3_1_loc9`='Ack, I don\'t feel so good.' WHERE `entry`=8761;
...
,`Text0_1_loc9`='Don\'t be alarmed... while my gryphons may not be entirely alive, they will still carry you faithfully to your destination. Tell me... which tower do you seek?'
...
,`Text0_1_loc9`='Hello. What brings you to Chillwind Camp today?'
...
,`Text0_1_loc9`='Do you need something, $C?  Perhaps I can assist you.'
...
,`Text0_1_loc9`='Greetings, $R. Your noble actions are acknowledged. May Elune protect you.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='All hail the exalted hero!',`Text1_0_loc9`='The history of your trip will be told for many years to all visitors!',`Text1_1_loc9`='The story of your journey will be told for years to come!' WHERE `entry`=8893;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='I finally have a story to tell my grandchildren about... A traitor to the kingdom was living among us!',`Text3_0_loc9`='"In truth, I never loved this gnome ..."',`Text3_1_loc9`='Truth be told, I never liked that gnome...' WHERE `entry`=8893;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='We are lucky to have survived this ordeal. If it wasn\'t for you, everyone on this island could have been killed!',`Text5_0_loc9`='It is amazing how many of them live among us. I have known Spark for many years and could never even have imagined that he was a traitor.',`Text5_1_loc9`='I wonder how many more of them live among us. I knew Spark for years - never could I have imagined that he was a traitor.' WHERE `entry`=8893;
...
,`Text0_1_loc9`='How fares your search for the Mark?'
...
,`Text0_1_loc9`='Their day will come, $N.$B$BAnd when it does, I will be there.'
...
,`Text0_1_loc9`='Here lie the remains of Weeder Greenthumb, one of Watcher Jhang\'s druid companions. By all appearances he was killed quick and clean while trying to make his escape from the Slave Pens.'
...
,`Text0_1_loc9`='I am here to thank the savior of my life.'
,`Text0_1_loc9`='You probably don\'t remember me, but you saved my life. I have only recently become healthy enough to walk on my own.$B$BI wanted to thank you for what you did for me and apologize for what I may have said... Thank you, $N. May Elune always watch over you.'
...
,`Text0_1_loc9`='We cannot afford to let our guard down, $C. This world is crawling with agents and allies of the Burning Legion. If you come across anything strange, don\'t hestitate to show me.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='I am the leader of the Blood Watch defenses. What can I help you with?',`Text1_0_loc9`='"Hi, are you here to learn about the Bloodmyst conflict?"',`Text1_1_loc9`='Hello, are you here to learn about the conflict in Bloodmyst?' WHERE `entry`=9172;
UPDATE `locales_npc_text` SET ,`Text3_0_loc9`='We unquestioningly serve the Light. Perhaps you have aroused curiosity and want to know more about our goals?',`Text3_1_loc9`='We serve the light unquestioningly. Perhaps you might be a bit more curious about our purpose?' WHERE `entry`=9172;
...
,`Text0_1_loc9`='What assistance can I offer in your studies?'

,`Text0_1_loc9`='This land has been ravaged by the crash. While you may not follow our philosophies, $C, I urge you to do whatever you can to aid in the healing process.'
,`Text0_1_loc9`='Greetings, my $G brother : sister;. How can I guide you today?'
,`Text0_1_loc9`='May the winds guide you, $N.'

UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='I\'ve always liked sorting and organizing things. I guess I take after my mother.',`Text1_0_loc9`='"Our expedition is very interested in new plant species. And not just medicinal or edible.$B$B. Plants are the foundation of many other life forms. The better we understand them, the better we understand nature as a whole."',`Text1_1_loc9`='Learning about new plant species is extremely important for our expedition. Not just the medicinal or edible ones either.$B$BPlants provide the foundation for many other forms of life to exist. Understanding them allows us to better understand nature as a whole.' WHERE `entry`=9199;




UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='The Defenders of Blood Watch protect this outpost from any threat.',`Text1_0_loc9`='We are here to protect the Blood Outpost from the Solar Hawks.',`Text1_1_loc9`='The Defenders are here to protect Blood Watch from the Sunhawk threat.' WHERE `entry`=9206;
,`Text2_1_loc9`='We\'ve recently heard word of a creature of immense power being summoned near the Vector Coil. Fear not, should anything threaten the town, we will give our lives to protect it.'
...
,`Text0_1_loc9`='Do not be fooled by the ruins surrounding us, $C. Dalaran is as powerful as ever.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='The Greatmother raised all of us. Any Mag\'hari that you see has had their life touched in some special way by the Greatmother. We will miss her greatly when she passes.',`Text1_0_loc9`='Great Mother says I was named after the great hero of the orcs.',`Text1_1_loc9`='Greatmother tells me that I was named after a great orcish hero.' WHERE `entry`=9297;
...
,`Text0_1_loc9`='If jewelcrafting is what you seek, you\'ll find Telia\'s shop on the south end of the Royal Exchange.'




,`Text0_1_loc9`='Why you mean to Lump? Lump hungry, dat\'s all.'
,`Text0_1_loc9`='OK! Lump tell you anything you want!'
,`Text0_1_loc9`='Boulderfist hungry! Need food! Warmaul ogre tribe kick Boulderfist out of mound to north. Many more Boulderfist to feed now.'
,`Text0_1_loc9`='Dat not true. Me just want to nibble. I don\'t eat all. Ok, maybe I eat da little ones.$B$BDey so delicious!'
,`Text0_1_loc9`='<Lump shrugs.>$B$BYou bring da war to da Boulderfist. We put it in da stew.'
,`Text0_1_loc9`='Get me out of here, $R!'
...
,`Text0_1_loc9`='You\'re definitely strong, $R, but do you have what it takes to become the Warmaul champion?'
...
,`Text0_1_loc9`='The Burning Legion. Demons. I see them as clearly as you can see your own hand in front of your face. That is, I used to be able to see them clearly.$B$BWith the Legion\'s return come new machinations. Under normal circumstances, I am able to sense the presence of a demon from a thousand paces.$B$B<Altruis grimaces.>'
,`Text0_1_loc9`='They elude me. I cannot see past their defenses. They have put in place wards to prevent detection.$B$B<Altruis points westward.>$B$BThey fear us because they know that we fear nothing. The cost for such power is great, the sacrifices many.'
,`Text0_1_loc9`='<Altruis turns to face you and smiles.>$B$BI do not.$B$B<Altruis points to his steed, Nethrandamus.>$B$BWe must stop them before these forge camps are able to complete whatever it is that they are building.'
,`Text0_1_loc9`='That is what these structures that litter the landscape are called. The Legion have employed the mo\'arg and gan\'arg to build weapons of mass destruction at these mobile forge camps. Let us not find out what it is that they intend to build here in Nagrand!$B$BYou will be my eyes. Your weapons will be my fury.'
...
,`Text0_1_loc9`='<Floon makes a series of strange clicking and clucking sounds.>'
,`Text0_1_loc9`='Are you serious? He already killed me! What more could he want?'
...
,`Text0_1_loc9`='You seek the hunters?  You will find them on the second level of the Trader\'s Tier, in the Hall of the Hunt.'
...
,`Text0_1_loc9`='You can find Arthaid, our stable master, outside of the Caregiver Center. He is located on the upper level of the central hub, near the Exodar\'s main entrance.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='The Exodar\'s vaults are vast and well-protected. Your goods will come to no harm here.',`Text1_0_loc9`='We guard the exodar warehouses. Do you want to leave these goods in storage or pick them up?',`Text1_1_loc9`='We control access to the Exodar\'s storage facilities. Are there goods you wish to store or remove?' WHERE `entry`=9567;
...
,`Text0_1_loc9`='In my years as a member of Explorers\' League, I\'ve been all over Azeroth, but I\'ve never seen anythin\' quite like Bloodmyst.'
...
,`Text0_1_loc9`='All muscle and no brain, that\'s what peons are! They\'re great when you can motivate them, but they have to be \'kick\' started, if you know what I mean.'
...
,`Text0_1_loc9`='I have just the thing you need to cast your spell.'
...
,`Text0_1_loc9`='Younger races love the Winter Veil festival. The celebration center is located in the bank of Ironforge.'



,`Text0_1_loc9`='If you wish to truly experience the feast of Winter Veil, you should go to Orgrimmar.'


,`Text0_1_loc9`='The largest celebration of the Lunar Festival is taking place in Moonglade. If that\'s too far to travel to, there are druids offering transport from the Valley of Wisdom.'

,`Text0_1_loc9`='The largest celebration of the Lunar Festival takes place in the Moonlit. Druids from the Top of the Elders on Thunder Bluff will happily take you there.'
...
,`Text0_1_loc9`='We\'re here to protect Gadgetzan interests in Un\'Goro and that\'s none of your business.'
...
,`Text0_1_loc9`='The Illidari demons keep me here because of my knowledge of ancient draenei crystals and relics.$B$BThey\'ve enslaved many of my people and use us to look for a powerful crystal... one that in all likelihood is not even here.'
,`Text0_1_loc9`='Why faire, moans illidari does not catch up with me, then it will be of the naga mark cage Zangar. join  Illidan and his alli\'aura actually apport that slavery most tribes Rous. There is no hope for my people.'
...
,`Text0_1_loc9`='<Greatmother Geyah\'s violet eyes lock onto yours.>$B$BYes...'
...
,`Text0_1_loc9`='Many years ago, my men and I followed the wizard Khadgar and the paladin Turalyon to this world. Our sole aim was to annihilate the orcs and their vile kin. Yet something went terribly wrong in the final hours of our war.$B$BUltimately, this dark world was ripped asunder - and my dear friends were lost to the void.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='These people arrived from Shattrath a few nights ago and they haven\'t stopped arguing since then.$B$BI\'m glad to see that hasn\'t turned you away, I was beginning to think they were scaring off potential customers.',`Text1_0_loc9`='I hope these cranks from Shattrath will soon end the fight. They get on my nerves.$B$BWhat can I help you with?',`Text1_1_loc9`='I hope these Shattrath folks stop fighting soon. They\'re beginning to get on my nerves.$B$B How can I help you?' WHERE `entry`=10022;
...
,`Text0_1_loc9`='The spirit of water has left us. Our tribe is doomed.'
,`Text0_1_loc9`='The winds do not speak to our tribe anymore, $N. My people are lost without elders to bring the spirits to them.'
,`Text0_1_loc9`='These chains that bind me prevent me from bringing the spirit of fire to my people, $N. Souls without fire are souls that cannot rebel against their masters.'
...
,`Text0_1_loc9`='If you haven\'t already, make sure that you offer your assistance to Rina Moonspring.'
...
,`Text0_1_loc9`='Do not forget, $C, battles still rage in Azeroth. Will you return to help the Horde in Alterac Valley?'


,`Text0_1_loc9`='How are ye? Had yer fill o\' Outland, and ready ta head back ta Alterac Valley and give the Horde what for?'
,`Text0_1_loc9`='The Silverwing Sentinels still fight the Horde in Warsong Gulch, $C. What remains to be seen is if you will return there to help them.'



,`Text0_1_loc9`='Only a mage can learn portal magic, $C.'
,`Text0_1_loc9`='A mage... you seek to learn the magic of portals, yes?'
...
,`Text0_1_loc9`='No, $R. Your bulk would only crush one of these noble creatures.$B$BNow, away with you!'
...
,`Text0_1_loc9`='<The water elemental is ready to surge.>'
...
,`Text0_1_loc9`='<The grunt\'s mouth waters, anticipating bloodshed.>'
...
,`Text0_1_loc9`='<Dark magic ripples from the necrolyte.>'
...
,`Text0_1_loc9`='<Warchief Blackhand towers over the field.>'
...
,`Text0_1_loc9`='Prospecting is the primary method of finding gems!   You simply use the prospecting ability (which is found in the general tab of your spellbook) on a stack of five ore to extract the gems from it.  Any type of non-precious ore will do!    $B$BBetter quality ores will provide more valuable gems so you will find higher quality gems in iron ore than in copper ore.'
...
,`Text0_1_loc9`='Be gone, mortal! Your kind is unwelcome here...'
...
,`Text0_1_loc9`='To pass beyond my Hall, you must defeat me in a game of skill!  Control your king when you are ready to begin...'
...
,`Text0_1_loc9`='Here in Outland, our forces fight against the Horde to control the Eye of the Storm. It is dangerous, fighting amidst the raging energies of the Nether. Do you have what it takes to join us?'
...
,`Text0_1_loc9`='Ah, another $C looking to be a gladiator, eh? Good!$B$BI sell the arena team charters you\'ll need to participate in ranking Steamwheedle Fighting Circuit matches.'
...
,`Text0_1_loc9`='Greetings, $C. If I might be so bold, may I remind you that -- while I attune myself to the magics of Hellfire Citadel -- there will undoubtedly be Hellfire wardens biting at my proverbial heels!$B$BSo, do be an upstanding member of your Horde and play the part of the hero... and protect me!'





,`Text0_1_loc9`='Welcome, $N. My expertise is in the art of working with primal mooncloth. Tailors interested in becoming mooncloth specialists often ask me to teach them our ways.'
...
,`Text0_1_loc9`='Pleased to meet you! I\'m Gidge, the resident spellfire tailoring expert here in Shattrath. Not that there\'s any competition, but if you\'re interested in learning to be a spellfire tailor and haven\'t settled on a specialization, I can help.'
,`Text0_1_loc9`='If you\'re not a tailor, I don\'t think any of my patterns will interest you, but you\'re welcome to browse!'
,`Text0_1_loc9`='If you\'re seeking patterns or knowledge about shadoweave tailoring, I\'d be happy to help you.'
...
,`Text0_1_loc9`='They fear my words. They make an example out of me. A mockery of the one true god, Neptulon.$B$B<Skar\'this spits.>$B$BRetribution comesss, mortal. The glorious hand of the Tidehunter will one day sweep through the non-believers like a scythe against a new harvest.'





UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='When I first set up my rogue academy in Shattrath, it wasn\'t nearly this crowded. Then, the refugees started flooding in and the naaru needed every available building to house them.$B$BI\'ve closed the doors to my academy for now, but it\'s not permanent. I\'ll find a new place to set up.$B$BThen, a new generation of rogues will learn such staples as the gouge\'n grin, combat looting, and blaming someone else for breaking polymorph. And who can forget the central rule of roguery --- real rogues don\'t feint.',`Text1_0_loc9`='"For the proper use of slipping away, the main thing is to understand that the very best 15 seconds of your life are very often the last."',`Text1_1_loc9`='The trick to using evasion is realizing that the best fifteen seconds of your life are often the last.' WHERE `entry`=10686;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Swords, claws, daggers, of course -- I\'ve trained rogues in the use of them all. Now maces, I won\'t touch maces and I won\'t instruct any rogue who gets it in his head to wield one.$B$BThere\'s nothing stealthy about a mace. You\'re in for a noisy kill and a long cleanup if you go that route.',`Text3_0_loc9`='"In my first classes, there are always plenty of young men with a burning gaze. But few of them pass the first test.$B$B. I\'m already tired of swearing at them: ""If I say - disappear, you have to disappear!"". All the same, they don\'t listen. Now unsuitable just die when tested."',`Text3_1_loc9`='My early classes are always filled with bright-eyed young lads. Few make it past the first test, though.$B$BI\'ve given up on shouting, \'when I yell vanish, you need to vanish.\' They never listen. Now, the test simply kills the inept.' WHERE `entry`=10686;
...
,`Text0_1_loc9`='I am Zarevhi of the Consortium. My skills as a transmuter are known in a thousand worlds.'
,`Text0_1_loc9`='Oh, no!  My Fei Fei would never take someone else\'s things!  He\'s a good dog... he just needs attention sometimes. If you give him a treat, then you see!'
...
,`Text0_1_loc9`='You do not have enough reputation with or have not pledged allegiance to The Scryers.'
...
UPDATE `locales_npc_text` SET ,`Text1_0_loc9`='"If demons are fallen, where did they fall from?"',`Text1_1_loc9`='If the demons fell, where did they fall from?' WHERE `entry`=10732;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='I think I need a bath. *sniff*  I think you need one, too!',`Text3_0_loc9`='Would a tauren paladin be a sacred cow?',`Text3_1_loc9`='Would a tauren paladin be a holy cow?' WHERE `entry`=10732;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Does this dress make me look fat?',`Text5_0_loc9`='I\'m sure Illidan\'s not so bad at heart. He just needs a mom too.',`Text5_1_loc9`='I bet Illidan is a nice guy underneath. He just needs a mama, too.' WHERE `entry`=10732;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='I bet ice cream would taste better if it were socketed!',`Text7_0_loc9`='"Boys have insects, girls have curls!"',`Text7_1_loc9`='Boys have cooties and girls have beauty!' WHERE `entry`=10732;
...
UPDATE `locales_npc_text` SET `Text0_1_loc9`='Why isn\'t the Outland called Draenor anymore?', `Text1_1_loc9`='UDB Missing US text' WHERE `entry`=10734;





,`Text0_1_loc9`='When you\'re done visiting this exotic city, perhaps you would be interested in celebrating with us. The Lunar Festival is underway in Moonglade; the other cities have transport to the festivities. Come and join the other revelers!'

,`Text0_1_loc9`='It is good to see you again, $C $N. Dornaa has been asking about you.'
,`Text0_1_loc9`='It is good to see you again, $C $N. Salandria has been asking about you.'
...
,`Text0_1_loc9`='The crossbow can be learned from Woo Ping, the human weapon master at Weller\'s Arsenal in Stormwind, Handiir, the draenei weapon master found in the Trader\'s Tier within the Exodar, or Bixi Wobblebonk, the gnome weapon master within the Timberline Arms in Ironforge.'
...
,`Text0_1_loc9`='There\'s no finer expert I know on axes than Buliwyf here! One hand, two hands... he\'s a master of it all!'
,`Text0_1_loc9`='My pal Buliwyf here can show you how to use fist weapons... or, if you prefer, Ilyenia Moonfire - she\'s the night elf weapon master on the Warrior\'s Terrace in Darnassus - can show you, too!'
,`Text0_1_loc9`='Buliwyf here will happily teach you everything there is to know about guns!'
...
,`Text0_1_loc9`='I can\'t see why you want to learn something else... but I suppose I can point you in the right direction. What training are you after, specifically?'
...
,`Text0_1_loc9`='The Sons of Gruul must be defeated if we are to shake off our shackles and live as free ogres once more!$B$BWe must work quietly, yet quickly, if our underground resistance is to have a chance of success.'
...
,`Text0_1_loc9`='I don\'t care who you are or what you do outside of the Skyguard, but while you\'re here you will do as you\'re told.'
...
,`Text1_0_loc9`='You kill gronn!  Now you fight things from sky?'

UPDATE `locales_npc_text` SET `Text2_1_loc9`='', `Text3_0_loc9`='Dis drink good!', WHERE `entry`=10838;
,`Text5_0_loc9`='$G King : Queen; not angry with me?'
,`Text7_0_loc9`='Now all Sons of Gruul dead!  Now new $G king : queen; lead all ogres to Ogri\'la!'
...
,`Text0_1_loc9`='"I have a suggestion for you, | 3-6 ($R). Please think carefully - this decision will not be easy to reverse.$B$B It is time to formalize your allegiance to our organization. I need to know in what capacity you want to serve us, so that we can reward you properly."'
...
,`Text0_1_loc9`='Hey, comrade. If you get yourself in good with the Skyguard, I can offer you a direct flight to our base, Blackwind Landing, in the Skethyl Mountains.$B$BDo you like my beautiful nether ray?  It is lovely.'
...
,`Text0_1_loc9`='Forgetting your skill in Transmutation Mastery is not something to do lightly.$B$BAre you absolutely sure?'
...
,`Text0_1_loc9`='Can\'t you see that I\'ve got places to go and people to see! Step aside, peasant!'
...
,`Text0_1_loc9`='My brother Krixx thinks he has it bad working in Orgrimmar. Nothing compares to the stench of this place. At least the boss had the decency to give me hazard pay!$B$BWhat? Do you want to see where the zeppelin is? Good thing I\'ve got my zeppelin tracker right here!'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='The stranded Alliance sailors know they\'re going to die, yet they fight us tooth and nail.$B$BImpressive and pathetic at the same time.',`Text1_0_loc9`='"In a few hours, the remnants of the Alliance fleet on the Bare Day will be defeated. They are surrounded and doomed."',`Text1_1_loc9`='It will be a matter of hours before the Alliance in the Derelict Strand are crushed. They are surrounded and outnumbered.' WHERE `entry`=11586;
...
,`Text0_1_loc9`='Why does everyone keep saying the LAST thing we gnomes need is more sugar?!'





,`Text0_1_loc9`='I don\'t know why the Forsaken burn a wicker man every night of Hallow\'s End instead of a real one, but it\'s their holiday.'
...
,`Text0_1_loc9`='There\'s always a need for more kegs at Brewfest!$B$BI\'ll lend you the reins to one of my personal rams.$B$BEvery time you bring me a keg, I\'ll give you some tokens. I\'ll even let you use the ram for a bit longer for every keg you bring me!  $B$BTake heed! Once you start this, you won\'t be able to do it again until tomorrow.$B$BAre you sure you\'re ready to do this?'




,`Text0_1_loc9`='When you get a ram, you also get the reins. These aren\'t your grandma\'s reins though, you\'ve gotta use them!$B$BJust loosen up on the reins a few times to build up some speed. Keep on loosening up and GIDDYUP!  You\'ll be flying!$B$BBut the faster he goes the quicker he\'ll get tired. So you have to be careful.'
...
,`Text0_1_loc9`='If you\'re looking to practice fire fighting, this is the place. There may be a heap of snow hereabouts, but you never know when Steelgrill or those gnomes\'ll cause an explosion, eh?'
,`Text0_1_loc9`='We set up this area to practice fire fighting. You never know when the town will be imperiled!'
...
,`Text0_1_loc9`='You\'d best scram, $N. I do not want Jonah\'s death to be linked back to me.$B$BIt\'ll be hard enough to establish myself as leader of this lot without them knowing I had their previous skipper killed.'
...
,`Text0_1_loc9`='I\'m almost jealous of our Mr. Wavesinger. Why, he may well be prettier than me!'
...
,`Text0_1_loc9`='I\'m sorry, I\'ve little time for speaking to anyone other than the wisps and the captain to report my findings. Forgive me.'
...
,`Text0_1_loc9`='You must survive Ahune\'s minions while we channel our flames. Do not approach the Frost Lord until we can wither him.'


UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='It is truly a pleasure to see you again, $N.',`Text1_0_loc9`='$N! And I worried about you there. What held you back?',`Text1_1_loc9`='$N! I\'ve been wondering how you were. What\'s kept you?' WHERE `entry`=12576;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='I trust you\'re taking every precaution....$B$BThis is a dangerous place and I couldn\'t forgive myself if something were to happen to you.',`Text3_0_loc9`='"We have to hurry,$N. The destructive plans of Malygos will soon be impossible to stop."',`Text3_1_loc9`='We must hurry, $N. Malygos\' ruinous plans will soon be irreversible.' WHERE `entry`=12576;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='In times such as these, dear friends are invaluable.$B$BBe safe, $N. As safe as one can be in a place like this....',`Text5_0_loc9`='"If you hadn\'t saved, saved; me from this prison, now I would be already dead.$B$BI have not forgotten this ..."',`Text5_1_loc9`='If you hadn\'t rescued me from that prison I surely would have succumbed by now.$B$BI have not forgotten....' WHERE `entry`=12576;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='When our duty here is behind us, I shall find a way to repay you for my rescue.',`Text7_0_loc9`='"My strength is returning, but slowly ...$B$BHopefully soon I will be able to demonstrate to you all the splendor of my true form."',`Text7_1_loc9`='My strength is returning, slowly....$B$BI hope to be able to show you the glory of my true form soon.' WHERE `entry`=12576;
...
,`Text0_1_loc9`='I glad you are here. Now that you know everything about our festive lights and the tradition of honoring them ... as well as the bonfires of our enemies and what should die out ... you can return and get your reward.'
...
,`Text0_1_loc9`='These infants will live. With love and affection they will grow to be strong members of the Horde, and with time the horrible reminders of their shattered lives will fade.'
...
,`Text0_1_loc9`='Hrm? Oh. Pardon me if I seem distracted; I fear for the men of Northwatch. I should have sent some of my students to aid them. Now, how may I help you?'
...
,`Text0_1_loc9`='My teachings are only of use to mages. I cannot help you, $C.'
...
,`Text0_1_loc9`='"How you doing, buddy$N? $G Came: Came; chat with other club members?"'
,`Text0_1_loc9`='Good seein\' you again, $N. I hope our club be treatin\' ya right.'
,`Text0_1_loc9`='"Hey$N, how you doing? $G Came: Came; chat with other club members?"'
,`Text0_1_loc9`='Hey, $N!  I hope you\'ve been enjoying our club!'
...
,`Text0_1_loc9`='<Thayreen\'s stare is blank. Cleansing Vordrassil\'s corruption has taken its toll on the druid.>'
...
,`Text1_0_loc9`='Squid guts! Squid Rryi!'
,`Text3_0_loc9`='"Piastres! Stir, land rats!"'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='There are two zeppelin towers outside Orgrimmar. The eastern tower serves Tirisfal Glades and Stranglethorn Vale, while the western tower serves Northrend.',`Text1_0_loc9`='Where do you want to go?',`Text1_1_loc9`='Where do you want to go?' WHERE `entry`=13310;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Icefang has carried me through countless battles.$B$BDon\'t let her lack of armor fool you. She\'s the toughest bear I know.',`Text1_0_loc9`='"Don\'t dare to detain me, girl!$B$B A battle is coming soon!"',`Text1_1_loc9`='Do not tarry here, wench!$B$BThere\'s fighting to be done!' WHERE `entry`=13565;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='We fight for the glory of Brunnhildar!',`Text3_0_loc9`='"The Ice Fang shows great courage, going into battle without armor.$B$B Perhaps her example will instill a little courage in you,$N."',`Text3_1_loc9`='Icefang shows great courage for entering the battlefield unarmored.$B$BPerhaps her example could instill some courage in you, $N.' WHERE `entry`=13565;
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='I will tear you limb from limb.',`Text1_0_loc9`='Are you challenging me?',`Text1_1_loc9`='You challenge?' WHERE `entry`=13660;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='You don\'t look so tough.',`Text3_0_loc9`='Do you think you have enough strength for this?',`Text3_1_loc9`='You think you have what it takes?' WHERE `entry`=13660;
,`Text0_1_loc9`='Well met, Battle-Sister. I can assist you in recovering lost companions.'
,`Text0_1_loc9`='"Glad to meet you, sister in arms. I can stall your pets or help you get your fallen comrades back."'
...
,`Text0_1_loc9`='Elder Pamuya is just outside Warsong Hold.'
,`Text0_1_loc9`='Elder Igasho was last seen exploring within The Nexus.'
,`Text0_1_loc9`='You\'ll find Elder Northal inside the Transitus Shield in Coldarra.'
,`Text0_1_loc9`='Last I heard, Elder Sardis was venturing to Valiance Keep.'
,`Text0_1_loc9`='Elder Bluewolf in trapped within the battle for Wintergrasp.'
,`Text0_1_loc9`='Elder Wanikaya can be found at Rainspeaker Rapids in Sholazar Basin.'
,`Text0_1_loc9`='Elder Sandrene has traveled to Lakeside Landing in Sholazar Basin.'
,`Text0_1_loc9`='Go to Stars\' Rest in Dragonblight and you will find Elder Morthie.'
,`Text0_1_loc9`='Elder Thoim has spent many years at Moa\'ki Harbor in Dragonblight.'

,`Text0_1_loc9`='Last I knew, Elder Nurgen was in Azjol-Nerub.'
,`Text0_1_loc9`='You\'ll find Elder Whurain at Camp Oneqwah in Grizzly Hills.'


,`Text0_1_loc9`='Elder Beldak can be found at the Westfall Brigade Encampment in Grizzly Hills.'
,`Text0_1_loc9`='Utgarde Keep is where you\'ll find Elder Jarten.'

,`Text0_1_loc9`='Elder Tauros found his way to Zim\'Torga in Zul\'Drak.'
,`Text0_1_loc9`='Elder Ohanzee is located in Gundrak.'
,`Text0_1_loc9`='Elder Graymane was last seen visiting K3 in the Storm Peaks.'
,`Text0_1_loc9`='Elder Muraco is just outside Camp Tunka\'lo in Storm Peaks.'

,`Text0_1_loc9`='Elder Stonebeard resides at Bouldercrag\'s Refuge in the Storm Peaks.'
,`Text0_1_loc9`='Elder Yurauk can be found in the Halls of Stone.'
...
,`Text0_1_loc9`='Naznik the barber is located on the upper floor of the Trade Quarter, near the bank.'
...
,`Text0_1_loc9`='Wait, $C....$B$BOne... final request...'
...
,`Text0_1_loc9`='Skinners and leatherworkers of all sorts may be Legendary Leathers in the Magus Commerce Exchange, northwest Dalaran.'
...
,`Text0_1_loc9`='Greetings, $C.$B$BWhen the Alliance controls Wintergrasp Fortress, I will open a portal for those who wish to travel there.'
,`Text0_1_loc9`='Greetings, $C.$B$BWhen the Horde controls Wintergrasp Fortress, I will open a portal for those who wish to travel there.'

,`Text0_1_loc9`='Greetings, $C.$B$BThe Horde now controls Wintergrasp Fortress. Use the portal, if you like.'



UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='When it comes to treasure, never be lookin\' sideways at lootin\' someone else\'s junk. Stolen goods be much sweeter, ya? But free is free, no matta how it got that way!',`Text1_0_loc9`='"I call it ""three-finger discount."" In theft, the most important thing is your hands ... and if they fail, they will always help out a knife by the side, clasped in the same hand.$B$B Skillful pens are more expensive than gold, remember carefully."',`Text1_1_loc9`='I always be up for a nice three-finger discount. Stealin\' be all in the wrist... and when that fails ya, then ya stick somethin\' sharp in between the ribs, and that\'s all in the wrist too.$B$BSkilled hands be worth more than a steady paycheck, ya heard?' WHERE `entry`=14090;
...
,`Text0_1_loc9`='Yes, of course, but please be more careful in the future.'
...
,`Text0_1_loc9`='I tell you, it sure is fun to see you work!  And you sure go through a lot of bombers!'
...
,`Text0_1_loc9`='Necessary for imbuing your spells and abilities with Glyphs, the Lexicon of Power is an invaluable resource for everyone. These ancient tomes are always found near inscription trainers.'
...
,`Text0_1_loc9`='"It is foolish to praise a natural phenomenon; spring will come regardless of whether someone will celebrate its onset. But, in any case, this is a great reason to enjoy sugar!"'

,`Text0_1_loc9`='Noblegarden time! I\'ve already found a lot of eggs. Great weather for the hunt, eh?'
,`Text0_1_loc9`='Noblegarden is the time when the druids of Azeroth celebrate the rebirth of life. The eggs are a symbol of fertility and an excellent way to bring everyone into the spirit, don\'t you think?'
...
,`Text0_1_loc9`='Our home was destroyed during the Cataclysm!$B$BAll of the rest of the survivors moved north to build Lor\'danel, but those of us that stayed behind are here for a reason. We WILL retake the Ruins of Auberdine from those Twilight\'s Hammer scum just as soon as we heal up.$B$BI hope that you can help us to deal with them in the meantime.'

,`Text0_1_loc9`='Many years ago I died tragically while attempting to help with a local murloc problem. However, I was content to stay and watch my family and friends instead of passing on to be with the Goddess.$B$BNow they are all gone, or worse, dead, and I have only one reason to stay.$B$BVengeance.'



,`Text0_1_loc9`='What are you doing out here? You should be inside fighting off the Blue Dragonflight!'

,`Text0_1_loc9`='The sentinel\'s body rests here, the apparent victim of the elemental onslaught that has overtaken the town.'

,`Text0_1_loc9`='Far too powerful for these elementals, Caylais and her hippogryphs must have been struck down by something else.'
...
,`Text0_1_loc9`='<Allyndia\'s body bobs gently in the surf. It appears that she\'s been dead for some time.>'
,`Text0_1_loc9`='<As you turn Barithras\' limp body over in the water, a brutal injury on his head makes it very apparent why he did not make it.>'
,`Text0_1_loc9`='<Dalmond\'s body looks almost peaceful, buried only slightly in the sand..>'
,`Text0_1_loc9`='<Grondal reaches futilely towards you as you approach, but his arm collapses as life slips from him.>'
,`Text0_1_loc9`='<Terenthis\' eyes stare unblinking into the distance, betraying the sorrow of his last moments.>'
,`Text0_1_loc9`='<The night elf turns to you as you approach and reaches for your hand.>$B$BIt is too late for me. We earned our fate with our pride. Go... others may have made it. Save any that you can.$B$B<Her grip loosens as life slips from her.>'
,`Text0_1_loc9`='So this... is what it feels like... to be mortal?$B$B<The question trails off as Mavralyn\'s breathing stops.>'
,`Text0_1_loc9`='<As you approach, you hear Cerellean gasp for breath. He looks to stand a chance if rescued soon.>'
,`Text0_1_loc9`='<Volcor\'s body lies motionless. As you begin to move away, a hand reaches out and grabs your ankle. He\'s alive!>'

,`Text0_1_loc9`='<Gershala rolls onto his side to look at you as you approach and you see a hopeful smile creep onto his face.>'
...
,`Text0_1_loc9`='Ohmygosh! I didn\'t think that I was ever going to see anyone ever again!$B$BYou have to get me out of here!'



,`Text0_1_loc9`='Greetings, $C.'
,`Text0_1_loc9`='Do you really want me to help you in the battle with Yogg-Saron?'
...
,`Text0_1_loc9`='Good to see you, $C.$B$BSorry... can\'t talk. We\'re in a bit of a fight here.'
,`Text0_1_loc9`='Just let me know when you\'re ready to take a squad out.$B$BI\'m holding some in reserve, so if you need a few more, come back.'
UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=14344;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Me not workin\' til elfs is gone!',`Text1_0_loc9`='Elfs kill too many peons in forest. Me sittin\' here where it safe.',`Text1_1_loc9`='Elfs kill too many peons in forest. Me sittin\' here where it safe.' WHERE `entry`=14346;
,`Text2_1_loc9`='Me not dyin\' for a little wood!'
,`Text0_1_loc9`='Greetings, $C.'
,`Text0_1_loc9`='How may I help you, $C?'
,`Text0_1_loc9`='Make it quick, $R.'
,`Text0_1_loc9`='Hurry, $C! There is no time to waste!$B$BSplintertree must not fall!'
...
,`Text0_1_loc9`='"Glory to you, hero! The echo of the defeat of Yogg-Saron has settled in these walls forever."'

UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Greetings.',`Text1_0_loc9`='Do you want a ride?',`Text1_1_loc9`='Would you like a ride?' WHERE `entry`=14454;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Is there anything that I can help with?',`Text3_0_loc9`='Glad to see you.',`Text3_1_loc9`='Good to see you.' WHERE `entry`=14454;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Looking for a ride?',`Text5_0_loc9`='"How are you, | 3-6 ($C)?"',`Text5_1_loc9`='How are you, $C?' WHERE `entry`=14454;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='A bit cold out, don\'t you think?',`Text7_0_loc9`='Glad to see you are doing fine.',`Text7_1_loc9`='I\'m glad to see that you\'re well.' WHERE `entry`=14454;
...
,`Text0_1_loc9`='Shhhh - Please don\'t give away my position when I\'m out in the field. Mathas needs to know what\'s happening out here.'
,`Text0_1_loc9`='It was folly for them to think us weak amidst recent events. There is no more hope for these trolls  - we will end this today.'
,`Text0_1_loc9`='We\'re expecting the Shatterspear Leader to show here at any moment. Be patient if you wish to join the attack.'
...
,`Text0_1_loc9`='I shouldn\'t have expected these filthy trolls to stay peaceful forever. There\'s no place for trust with any sympathizers of the Horde.'




,`Text0_1_loc9`='While the elements are doing their best to tear Darkshore asunder, I\'ve been struggling to protect the remaining wildlife.$B$BCan I count on your help, $C?'
...
,`Text0_1_loc9`='I appreciate your help defending the wildlife here. Hopefully we\'re not too late.'
,`Text0_1_loc9`='I wish I could tell you more, but until recently nobody believed such creatures existed. Long before the Titans shaped Azeroth into the world we see today, before the natural cycle of life and death as we know it, the Old Ones ruled over the elements and corrupted creation to serve their own malignant ends.$B$BFrom what Onu here tells me, the Titans ultimately defeated the Old Ones. Or, at least, they imprisoned them under the earth. Can something like that ever really die? I wish I knew more, but this is all pre-prehistory for me, and I\'ve been around a while.$B$BI know that there are some that worship the Old Ones, if you can believe that. That\'s like praying for the end of the world. These Old Gods make people crazy!'
...
,`Text0_1_loc9`='We must do more than hold the tree, $R. The Horde will never give up.$B$BWe must destroy them!'
...
,`Text0_1_loc9`='I\'m honor-bound to get these supplies to Crossroads. Pitch in or step aside.'
,`Text0_1_loc9`='Well, $N - are you ready to roll? It won\'t be easy!'


Text0_1_loc9`='Need some help finding your way? I know this place like the back of my hand.'Text1_0_loc9`='I\'m sad to see that the furbolgs could have been corrupted so easily, before they were our friends.'Text1_1_loc9`='It saddens me to see the furbolg all corrupted so readily. These used to be our friends.'
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='This place is infested... we\'ll need to make our way out of here with the relics as quickly as possible.',`Text3_0_loc9`='I did not see a single sleeping druid, they had to be swept away.',`Text3_1_loc9`='I haven\'t seen any of the sleeping druids. They must have been taken from here already.' WHERE `entry`=14549;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='We should have seen this coming. The corruption has been spreading for quite some time.',`Text5_0_loc9`='If the transformation of the furbolgs goes so far, what does that mean for the rest of Teldrassil?',`Text5_1_loc9`='If the furbolg could be this far gone, what does that say for the rest of Teldrassil?' WHERE `entry`=14549;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='There has to be a way to stop this corruption before it consumes us all.',`Text7_0_loc9`='Cursed be you, Fandral, but what did we all get into with your damn "World-Tree"?',`Text7_1_loc9`='Damn you, Fandral! What have you gotten us into with this cursed "World Tree?"' WHERE `entry`=14549;


,`Text0_1_loc9`='The quilboar have always scavenged the fringes of our camps for food and supplies, but direct assaults on our farms and homesteads? Something has sent them on a rampage recently.'
,`Text1_0_loc9`='<The quilboar wrinkles his nose at you and snorts.>'
,`Text3_0_loc9`='We\'re warriors, $N. <Snort> Many and proud.'
,`Text0_1_loc9`='Hi there!'
...
,`Text0_1_loc9`='I know all is not well in Shadowglen, but coming back to these woods is always like coming back home.$B$BEver peaceful. Ever pure.'
...
,`Text0_1_loc9`='Please $C, don\'t encourage Gorgal. We\'re supposed to observe and report - not raise us a ruckus.'

,`Text0_1_loc9`='Hey there, boss. I trust that you\'re enjoying your new promotion?$B$BWe all think that you\'re the one who\'s going to finally be able to replace that stinky ol\' Gallywix and take the title of Trade $G Prince : Princess;. But you didn\'t hear that from me!$B$BWe have a lot to do and very little time. Hope you\'re ready!'
...
,`Text0_1_loc9`='You don\'t have to be a priest to tithe. Your coin is just as welcome, $G sir : ma\'am;.'
,`Text0_1_loc9`='I\'m surprised that a $C like you could even see me, $N. I\'m stealth on a stick!'
,`Text0_1_loc9`='Sure, $N, I\'ll train you, $N. Just keep an eye out for those monkeys!'
...
,`Text0_1_loc9`='Do not trifle with me, $R.'
...
,`Text0_1_loc9`='I am told Pilgrim\'s Bounty is a time to reflect upon one\'s good fortune and share with all around you.$B$BWe are lucky to have found this world and its bold inhabitants; it is only fitting that we lend our knowledge and strength to these new-found allies.'
,`Text0_1_loc9`='Humans can\'t brew their way out of a tattered linen pouch, but there sure know how to cook. Pilgrim\'s Bounty? I\'m all for it!'
,`Text0_1_loc9`='The logistics involved in the optimal celebration of Pilgrim\'s Bounty are quite staggering... so many raw materials, so much labor, thousands upon thousands of crates of finished product shipped here and there and everywhere for countless Bountiful Tables.$B$BHonestly, I\'m quite impressed! And hungry... I can smell pumpkin pie. Can you smell that pie?'
,`Text0_1_loc9`='"Pilgrim\'s Bounty?" More like "Fool\'s Folly!"$B$BHundreds of cargo holds full of food given away for free... FREE! It boggles the mind!$B$BStill, I suppose I should shift some of my Poultry Portfolio funds to turkey... I can\'t believe how big of a bust that chicken investment was. Where did all those Noblegarden eggs COME from?!'


,`Text0_1_loc9`='The orcs and tauren are fortunate to have found one another, for each people\'s strengths compliment the other\'s. We are glad to join them in this celebration.$B$BEven the Forsaken partake, though to what end I am not certain...'
,`Text0_1_loc9`='Pilgrim\'s Bounty is a time to reflect upon one\'s good fortune and share with all around you.$B$BIn Mulgore and the Horde, we have found both a home and friends to enjoy its many fruits with.$B$BIt is our hope that every one of our allies will be able to join us in feasting and celebration.'
,`Text0_1_loc9`='Dem tauren, dey be KNOWIN\' how ta cook. Have ya SEEN all de food dey be servin\'?$B$BI\'m gonna eat \'til I die... an\' den come back from de grave ta be eatin\' some more!'
,`Text0_1_loc9`='"Why do we celebrate the Feast of Wanderers? Who knows. Probably out of habit. Personally, I don\'t care. I still can\'t tell the taste of pumpkin pie from a sore piece of meat. So what\'s the difference, what to cook?"'
...
,`Text0_1_loc9`='$G Mr. : Ms.; $N, so very good to see you.$B$BI hope that you are enjoying the Kaja\'Cola marketing campaign. We\'re planning a massive set of explosions for the next phase of the campaign. That always goes over well with our target demographic.'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Hi, babe! How do I look?',`Text1_0_loc9`='"I missed you so much! Where have you been?$B$BWell, will you answer or just stand there?"',`Text1_1_loc9`='I missed you so much! Where have you been?$B$BAre you going to answer me, or just stand there?' WHERE `entry`=14681;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Do you like my outfit?  It\'s for the party. I charged it to your account.',`Text3_0_loc9`='"Another guy molested me. What an insolence!$B$BDo you beat him, baby? Thank. I love you!"',`Text3_1_loc9`='There was another guy just hitting on me. Oh, the nerve!$B$BWill you beat him up for me, sweetie? Thanks. Love ya!' WHERE `entry`=14681;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='I can\'t wait for the day when you rise to the top. Just think, I\'ll be able to call myself Mrs. Trade Prince$B$BNot to mention buy all that stuff I\'ve always wanted!!!',`Text5_0_loc9`='"Take care of yourself. They say that pirates from the South Seas arrived in the bay.$B$BHm, maybe I should go and check it myself ..."',`Text5_1_loc9`='Be careful out there. I heard that there are Southsea pirates in the bay.$B$BHmm, maybe I should go check for myself...' WHERE `entry`=14681;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='Can we go on a nice, romantic picnic on top of Mount Kajaro?$B$BMake sure you pickup my favorite champagne!',`Text7_0_loc9`='You have a mischievous look. What\'s on your mind baby?$B$BA?',`Text7_1_loc9`='You\'ve got a miscievious look in your eye. What have you been up to, babe?$B$BWell?' WHERE `entry`=14681;

,`Text1_0_loc9`='Sweetie, where have you been? You know how worried I get when you don\'t check in with me!'
,`Text3_0_loc9`='Those other women are just friends, baby.'
,`Text5_0_loc9`='I know that I promised you last night, and the night before that, but I\'m taking you out someplace really nice tomorrow night!'
,`Text7_0_loc9`='How\'s my hot, company executive girlfriend today? With the way you run things around here, I think that any day now we\'ll be calling you Trade Princess $N!$B$BI cannot wait! I\'m gonna spend my days at the gym and working on my tan by the pool.'





,`Text0_1_loc9`='Yeah? Whatdya want?'
...
,`Text0_1_loc9`='I gots all kinds of brands of shades. Yous name it, I sell it!'
,`Text0_1_loc9`='Yes? It\'s not like you have enough money for my goods.$B$B <Missa inflates the bubble and bursts it.>$B$B Maybe you should go to the bank?'
,`Text0_1_loc9`='Here yous go. My best pair and I\'m giving them to ya cheap!$B$BYous gonna look sharp in them!'
...
,`Text1_0_loc9`='Am I still bleeding? I can\'t ... I can\'t keep this up much longer. Have you seen any of the archmages?'
,`Text3_0_loc9`='Kalytha! Archmage Selwyn was looking for you. She should be nearby...'
,`Text5_0_loc9`='Why didn\'t I flee with the others? They\'ve got the academy surrounded. We\'re trapped here.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='I\'ve got to keep the arcane wards charged.',`Text1_0_loc9`='"My strength ... is running out. Kalifa, please tell me that the supreme mages had a backup plan ..."',`Text1_1_loc9`='My strength ... is beginning ... to falter. Kalytha, please tell me the Archmages have a backup plan...' WHERE `entry`=14767;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='I can\'t maintain this shield much longer. Kalytha - are any of us going to survive this?',`Text3_0_loc9`='These creatures are even more! Where do they come from? What is happening in the capital?',`Text3_1_loc9`='More of these creatures! Where are they coming from? What\'s going on in the capital?' WHERE `entry`=14767;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Kalytha! Hurry - Archmage Selwyn wanted to see you, she said it was urgent. Maybe we can win this thing?',`Text5_0_loc9`='"That\'s all I can do to keep the crystals charged. Find one of the supreme mages, Caliph! I can barely hold on ..."',`Text5_1_loc9`='It\'s all I can do to keep these wards up. Find one of the Archmages, Kalytha! I feel like I\'m about to collapse...' WHERE `entry`=14767;
,`Text0_1_loc9`='Kalytha ... it is done. The Sarcen Stone is fully charged and is already diverting energy from the portal. Are you still the incredible swimmer I knew those many years ago? The stone must not be found by either the demons or our "beloved" Queen.$B$BSwim to the bottom of the lake, Kalytha, and bury the stone deep under the center arch. Hopefully the demonic invaders will not discover it when they raze the surrounding temple. Go!'
,`Text0_1_loc9`='<The shimmering vision does not acknowledge your presence. She is lost in her own world, reacting to events that played out thousands of years ago.>'
...
,`Text0_1_loc9`='Greetings, $C.$B$BThe Alliance currently control Wintergrasp Fortress. When the battle is about to begin, talk to me to enter the battle.$B$BThe next battle begins in $4354k..'




,`Text0_1_loc9`='Marooned! Blasted to bits by the Alliance and stranded on some island in the middle of who-knows-where?!$B$BBusiness as usual, right, $N?'
,`Text0_1_loc9`='Greetings, $C.$B$BThe Horde currently control Wintergrasp Fortress, but the next battle starts soon.  Get ready to head to Wintergrasp and support our forces!$B$BThe next battle begins in $4354k..'
,`Text0_1_loc9`='Greetings, $C.$B$BThe Alliance currently control Wintergrasp Fortress, but the next battle starts soon.  Get ready to head to Wintergrasp and support our forces!$B$BThe next battle begins in $4354k..'
...
,`Text0_1_loc9`='The whispering winds have made it known to me that a $R $C would come; that $Ghe:she; would assist me where many others have failed.$B$BCould you be the one?'
...
,`Text0_1_loc9`='Shipwrecked on an island infested with bomb-throwing monkeys? What\'s next... is there a volcano that\'s going to blow?!'
,`Text0_1_loc9`='You can see me? How can you see me, boss?$B$BI\'m going to have to work on that.'
,`Text0_1_loc9`='Training, massages, whatever you need, boss. Just don\'t forget me when you\'re the new Trade $G Prince : Princess;!'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Why are you interrupting my work here?! Explain yourself!',`Text1_0_loc9`='"You must have a good reason to bother me, insignificance!"',`Text1_1_loc9`='You\'d better have good reason to approach me, minnow!' WHERE `entry`=14827;
,`Text2_1_loc9`='What\'s this? What do you want with me, minnow?'





,`Text0_1_loc9`='Your efforts here shall not be forgotten, $N! I shall make certain of that.'
,`Text0_1_loc9`='You are not initiated in the old ways. There is nothing I can teach you, child.'
Text0_1_loc9`='The worgen will pass. We shall pass.$B$BOnly the earth and her secrets will remain. Are you willing to learn, $N?'


,`Text0_1_loc9`='Of course, I will share my knowledge with you. Especially if it helps us defeat the worgen.'
,`Text0_1_loc9`='I\'d have a hard time teaching you. It takes years of mental preparation to become attuned to the powers of the arcane.'
,`Text0_1_loc9`='Ask me for help and advice... just don\'t ask me for money, okay?'
,`Text0_1_loc9`='I swear this wasn\'t my fault. Why are you looking at me like that?'
,`Text0_1_loc9`='Even now, in the darkest of times, the teachings of the Light will guide you throught this world.'
,`Text0_1_loc9`='The Light is with you, $C. No harm will come to you today.'
...
,`Text0_1_loc9`='Do you see the gyrochoppa on the far side of the beach, $N?!'



UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=14875;
,`Text1_0_loc9`='Who would\'ve thought we\'d wind up here after everything we\'ve been through?'
,`Text3_0_loc9`='Looks like we\'re in a pretty tight jam. Think you can get us out of here?'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Oh, $N, we\'re marooned!',`Text1_0_loc9`='"I miss Kezan so much. Oh$N, will we ever see the port of Bilge Waters?"',`Text1_1_loc9`='I miss Kezan. Will we ever see Bilgewater Port again, $N?' WHERE `entry`=14880;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Sit with me a while. We can roast crabs over the fire and sing songs.',`Text3_0_loc9`='I have done so much for you! What are you doing to get us out of this island?',`Text3_1_loc9`='I put this all on you, but what are you doing to get us off of this island?' WHERE `entry`=14880;
...
,`Text0_1_loc9`='Look around you, $C!$B$BIsn\'t it all just beautiful?'
...
,`Text0_1_loc9`='"Don\'t be offended, baby, but now I\'m on the side of the merchant prince.$B$B Go your way, okay? You stop me from admiring the scenery."'
,`Text0_1_loc9`='Yeah? Whadya want?'




,`Text0_1_loc9`='Thank you for freeing Thrall, $N. He\'s been missed.$B$B<Aggra looks over at the Warchief.>'


,`Text0_1_loc9`='Oh, $N, you\'ve saved us again! Thank you for getting rid of those evil humans before they could get us!'

,`Text0_1_loc9`='Grapplehammer relies on me to get things done. A mind like his needs to be free of distractions.'
,`Text0_1_loc9`='Are you ready to be shrunkified? This may sting a little. And burn. The agony and convulsions will pass quickly, however.'
...
,`Text0_1_loc9`='It really is good to see you again, $N. Fur and all.'


,`Text0_1_loc9`='Can I provide you with anything, $N?'




UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=15040;
,`Text0_1_loc9`='Great blessings be upon you, good $R.'
...
,`Text0_1_loc9`='<The raptor peers at you, growls, and slobbers.>$B$B<It appears Subject Nine left behind an un-augmented clone of herself in order to cover her tracks. Clever girl! You ponder over what exactly you\'ve unleashed onto the cosmos...>'
...
,`Text0_1_loc9`='"Don\'t worry, child. I know that our agreement was ... temporary. Everything will be fine with me.$B$BA And you, you do not belong to this place. Your time has not come yet. I will help you return to the living world.$B$BThis will be mine."'



,`Text0_1_loc9`='The elements favor you. What will you ask of them?'
,`Text0_1_loc9`='The elements are fickle and best left out of untrained hands. My apologies, but I have no need for yours.'


,`Text1_0_loc9`='We grunts were ordered to charge once more - into a wall of pikes - I could not do it, $C. My weapon slid from my hands and my legs did not move.$B$BI am dishonored.'
,`Text3_0_loc9`='No orc should ever flee from battle as I did. Leave me to my disgrace. Would that I would die in this tower, but I dread learning what my ancestors think of my cowardice.'



,`Text0_1_loc9`='These hills and hidden trails are my home. For years I have used them on the hunt.$B$BI never thought I\'d use them to fight a war.'


,`Text0_1_loc9`='What d\'ye want, $C?'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='When d\'ye think we can leave?  I need ta get back to work.',`Text1_0_loc9`='Where are all these troggs coming from?  Were they livin\' underground the whole time?',`Text1_1_loc9`='Where are all these troggs coming from?  Were they livin\' underground the whole time?' WHERE `entry`=15140;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Might as well make yerself comfortable. Ironstock\'s not lettin\' anybody out until the troggs die down.',`Text3_0_loc9`='Have ye any news from outside?  I hear the trolls have been actin\' up too.',`Text3_1_loc9`='Have ye any news from outside?  I hear the trolls have been actin\' up too.' WHERE `entry`=15140;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='It\'s gettin\' awful crowded in here. I don\'t do well in confined spaces.',`Text5_0_loc9`='Ye\'d think that, after an earthquake of cataclysmic proportions, the LAST place ye\'d want ta be is indoors, wouldn\'t ye?',`Text5_1_loc9`='Ye\'d think that, after an earthquake of cataclysmic proportions, the LAST place ye\'d want ta be is indoors, wouldn\'t ye?' WHERE `entry`=15140;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='$N!  I hear you\'re Ironstock\'s new little whipping $R. What\'s she got ya doin\' now?',`Text7_0_loc9`='I feel like I\'ve been cooped up in here forever. Is it Brewfest yet?',`Text7_1_loc9`='I feel like I\'ve been cooped up in here forever. Is it Brewfest yet?' WHERE `entry`=15140;




,`Text1_0_loc9`='Volcano rocks for sale! Hot off the mountain! You want \'em, I got \'em!'
,`Text3_0_loc9`='Get your volcano rocks here! ...Great for cats!'
,`Text5_0_loc9`='Papers to weigh? Doors to stop? Windows to break? bam, Bam, BAM! Volcano rocks.'
,`Text7_0_loc9`='Volcano rocks! Limited time offer! Papers of authenticity and everything!'
,`Text0_1_loc9`='In our native tongue, "Una\'fe" can be translated as "Refuge." But the name no longer fits. From the moment we set up this camp, this strange jungle has threatened to engulf it.'
,`Text0_1_loc9`='They attacked Taurajo while our strongest were on the hunt. By some miracle, there was a gap in the Alliance lines through which myself and some others were able to carry the little ones...$B$B<Tawane trails off, trying not to cry in front of the children.>'
...
,`Text0_1_loc9`='The Barrens may be dry, but these plains once teemed with life. We roamed, we hunted, and we lived off the land.$B$BThen the Alliance came... slashing, burning, killing. We call these the Fields of Blood now, $C.$B$BThe refugees have all fled. Those who remain behind remain to fight.'
...
UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=15226;
...
,`Text0_1_loc9`='Only those who have the ranger general\'s approval may enter the Sunwell Plateau.'



,`Text0_1_loc9`='When we were packed into the Town-In-A-Box, they told us we\'d be deployed somewhere in Azshara. Is this Azshara?$B$BI ask you: who prepares a Town-In-A-Box and doesn\'t supply it with enough food to live on?! One measly Poultryizer?!$B$BWe all know how the "Micro" Mechachicken worked out.'


,`Text0_1_loc9`='This ain\'t much of a big challenge, mon, but we gotta know ya can handle the pit before we can take ya in.'
,`Text0_1_loc9`='They\'re in mid challenge, mon. Be patient.'


,`Text0_1_loc9`='I can\'t help ya. Go talk ta Zen\'Tabra if ya want druid trainin\'.'
,`Text0_1_loc9`='I can\'t help ya. Go talk ta Soratha if ya want mage trainin\'.'
,`Text0_1_loc9`='I can\'t help ya. Go talk ta Tunari if ya want priest trainin\'.'





,`Text0_1_loc9`='Nature will guide ya when all else fails.'

,`Text0_1_loc9`='In tha chaos of battle, it\'s tha balance of light and shadow that leads us ta victory.'

,`Text0_1_loc9`='Trust in ya bow. It\'ll be there for ya when ya need it most.'


,`Text0_1_loc9`='No snooping around, friend.$B$BIf you\'re looking to buy Crown holiday goods, you\'ll have to do it at the Lovely Merchant in the city.'
...
,`Text0_1_loc9`='It is my role to test our young initiates on the ways of the hunt.$B$BAnd that hasn\'t changed. Today, the quilboar are our prey.'


,`Text0_1_loc9`='I came over here to see if we could open up trade with these naga. Their reply wasn\'t very nice.'
,`Text0_1_loc9`='Greetings, $C. We shaman have gathered here at Firestone Point to watch over the land and tend to its wounds.'
...
,`Text0_1_loc9`='Are you interested in making some money?'
...
,`Text0_1_loc9`='There is nothing here for you. Now go.'
,`Text0_1_loc9`='Do you understand now, $N?'


,`Text1_0_loc9`='Nablya, is that you?'
,`Text3_0_loc9`='Have you come to observe?  Would you like a coconut?'
...
,`Text0_1_loc9`='These pygmies are cutting into profits!'
,`Text0_1_loc9`='You\'ve got the moves, $N. Use them!'


,`Text0_1_loc9`='Un\'Goro Crater serves a very specific purpose, $N. It is now time for you to learn that purpose.'
,`Text0_1_loc9`='I am Nablya, apprentice to Khaz\'goroth and envoy to Un\'Goro Crater. I am known as the Watcher.$B$BI stand here in the place of my master, who has since left Azeroth. He once stood in this very spot when he shaped many of his creations.'
,`Text0_1_loc9`='I am observing. It is my charge to watch over Un\'Goro, and I do so from this spot.$B$BI am also performing tests, and recording the results. These tests allow me to observe that which most interests me.'
,`Text0_1_loc9`='Simple stimulus-response tests. Normally my kind does not interfere with the matters of Azeroth, but here in Un\'Goro, we are free to take a more direct approach. As Un\'Goro is the experimental ground of the Titans, it is our right to do so.$B$BFor example, say Khaz\'goroth wants to know what happens when one of his creations is exposed to a sulfurous hot spring. He could wait for millenia, observing, and waiting for the creature to accidentally stumble and fall in. Or, he could place the creature in the water himself.$B$BIn Un\'Goro, we may do so.'
,`Text0_1_loc9`='Not exactly. In fact, many of the creatures here in the crater existed long before my master arrived... but some did not.$B$BNevertheless, we observe them all, without prejudice.'
,`Text0_1_loc9`='When the cataclysm struck Azeroth, it disrupted the cloaking mechanism that kept this terrace hidden. At that point, it was only a matter of time until the intelligent races discovered me here.$B$BThis was a scenario that, quite honestly, we did not foresee. It required us to perform some new tests. And you, $N, are my test subject.'
,`Text0_1_loc9`='I am not authorized to answer that question. I am, however, permitted to offer you a suggestion:$B$BSeek out Brann Bronzebeard.$B$BHe has already learned much of what there is to know about us, and he is teetering on the verge of another discovery. Help him, and he may help you uncover the knowledge that you desire.'
...
,`Text0_1_loc9`='$N! How ya doin\', hon?'
...
,`Text0_1_loc9`='I definitely did NOT sign up for this! Pygmies, zombies... Hobart better give me a huge raise!'
,`Text0_1_loc9`='Just when I thought it couldn\'t get any worse....'



,`Text0_1_loc9`='I\'m so glad that you asked, $N!$B$BNo one ever asks how stuff works. It\'s just here, gimme that, I\'m gonna blow stuff up. Or, don\'t bore me with the details, just let me point and shoot. Or, worse yet, who cares how it works, is it a bigger explosion than last time?$B$BI swear sometimes, I could just scream, you know? It\'s like I\'m always doing all of Hobart\'s work for him, but I never get any of the credit! I have got to be the most underappreciated, overworked, and underpaid tinkers assistant ever!$B$BWait, what did you ask about?'


,`Text0_1_loc9`='I don\'t see any good reason for these ogres to waste their lives sitting out here in the sand when they could join the Horde and work for us.$B$BI mean look at them! If we don\'t exploit them, who will?'
,`Text1_0_loc9`='Ogre look funny.'
,`Text3_0_loc9`='Me not like sand.'
...
,`Text0_1_loc9`='Greetings, hero. I craft and sell Bloodmage armor for magi.'
,`Text0_1_loc9`='Greetings, hero. I craft and sell Dark Coven armor for warlocks.'

,`Text0_1_loc9`='An ancient score is settled today.'

,`Text0_1_loc9`='Have you come to join the hunt, $N?'
,`Text0_1_loc9`='Be gone, $C. I have no need of you in my hunt.'
...
,`Text0_1_loc9`='The Corporal\'s a good man, but he\'s got tunnel-vision when it comes to his orders.$B$BSomething unnatural is happening to the land here, $N. This jungle shouldn\'t be here!'


,`Text0_1_loc9`='Get away from me, you monster!  Don\'t look at me!  I\'m hideous!'
,`Text0_1_loc9`='What are you doing here?  Get out of here!'

,`Text0_1_loc9`='I\'m NOT undead!  Not for long, anyway. My father will rescue me, I know it...'




UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Hey $Gman:woman;, I\'m just tryin\' to get my slice of the pie.' WHERE `entry`=15501;
UPDATE `locales_npc_text` SET `Text0_1_loc9`='Hey $Gman:woman;, I\'m just tryin\' to get my slice of the pie.', `Text1_0_loc9`='You want in on this? Smash and grab, baby!',, `Text1_1_loc9`='You want in on this? Smash and grab, baby!' WHERE `entry`=15501;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Hurry up, $C! Take everything you can!',`Text3_0_loc9`='All these dead Tauren got on \'em is beads and junk. Did you score anything good?',`Text3_1_loc9`='All these dead Tauren got on \'em is beads and junk. Did you score anything good?' WHERE `entry`=15501;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Hey, $C! This place is pretty picked over but you might still be able to find somethin\' worth your time.',`Text5_0_loc9`='Whoa, you aren\'t here to bust us, are you?',`Text5_1_loc9`='Whoa, you aren\'t here to bust us, are you?' WHERE `entry`=15501;
,`Text0_1_loc9`='I expect this operation to proceed without major incident.'
...
,`Text0_1_loc9`='The Warchief has promised to help us rescue our people and deal with Gallywix if we help them with the Alliance.$B$BIt sounds like a fair deal to me. The enemy of my friend is my enemy, right?'
...
,`Text0_1_loc9`='Can I help you with something?'
,`Text0_1_loc9`='Are you ready to begin the procedure?'

,`Text0_1_loc9`='I\'m a little busy at the moment, $C... return when I\'m less preoccupied.'
,`Text0_1_loc9`='Our equipment is really taking a beating out here!'
...
,`Text0_1_loc9`='The blood of the fallen cries out for justice.'


,`Text0_1_loc9`='The Battlescar is a dangerous place. All the armor in the world can\'t save a steam tank that\'s swallowed up by the earth.'
,`Text0_1_loc9`='What I\'m cooking up is way ahead of its time, $N.$B$BLook at these blueprints! It\'s like licking the future.'
,`Text0_1_loc9`='Sure, it\'s got bugs to work out. But the microtank is a marvel of engineering.$B$Bit uses one quarter the materials of a full-sized siege engine, and it can be mass-produced by anyone! ...with really tiny hands!'
,`Text0_1_loc9`='The Bilgewater Cartel will be in business here by the end of the day, mark my words.'

,`Text0_1_loc9`='This might be the only cool place left on the island... right next to the volcano!'



,`Text0_1_loc9`='Turn away, $C.$B$BBefore the cataclysm hit, we found something.$B$BWe dug something up that should\'ve stayed buried.$B$BPray to whatever you believe in that the landslide was enough to keep it down...'

,`Text0_1_loc9`='Are you going in there? I\'m not going back in there!'



,`Text0_1_loc9`='This was going to be a walk in the park until that airhead over there came out of nowhere with an army of gnomes.$B$BGallywix will have my head if we let these creepy runts one-up us here.'
...
,`Text0_1_loc9`='We have to rescue everyone and get out of here before the volcano explodes for real!'
,`Text1_0_loc9`='This region is one of the epicenters of the cataclysm that threatens to rend our world.$B$BIf we manage to survive, we must try to discover its cause.'
...
,`Text0_1_loc9`='Coach is here?! He\'ll have a plan.'



,`Text0_1_loc9`='Where the heck did all of these shredders come from?!'
...
,`Text0_1_loc9`='All the rest of our people are down there!'


,`Text0_1_loc9`='The Twilight\'s Hammer is a major power to be reckoned with. Thanks to us, Deathwing is free. Thanks to us Old Gods have risen from the bowels of the earth. Thanks to us... Hyjal burns.$B$BWhat do you think you have to offer us?'
...
,`Text0_1_loc9`='Are you here to help, $C? This valley serves as a natural chokepoint. If we can strangle this supply line, we buy our companions at the World Tree time to mount a counter-attack.'
,`Text0_1_loc9`='I don\'t understand where these supplies are coming from. Somehow Twilight\'s Hammer has found a way to assault the entire mountain at once...'

,`Text0_1_loc9`='What do you want, $R?'





,`Text0_1_loc9`='The Gordunni Ogres have blighted this land long enough. We are here to take this land and its resources for the Horde.'
,`Text0_1_loc9`='The Stonemaul clan serves the Horde!$B$BDuring the founding of Orgrimmar, when Kalimdor was being tamed as our people\'s homeland, the hero Rexxar defeated the chief of the Stonemaul ogre clan.$B$BThey have served the Horde ever since, and I\'ve called them in here to do the heavy lifting against the Gordunni clan.'
...
,`Text0_1_loc9`='It\'s been a long journey to get here, hon. Thank you!$B$BLet\'s get off of this island now.'

,`Text0_1_loc9`='You\'re a true $G hero : heroine;, $N! The poster-$G boy : girl; for the Bilgewater Cartel.$B$BOur stock is going to skyrocket now and I\'m going to get a raise!'
,`Text0_1_loc9`='This does not look good for the future of the cartel. Not one bit.$B$BYou have to pull our fat out of the fire, $N, or we might as well all just walk into that volcano up there.'
,`Text0_1_loc9`='Oh goodness, you did it, $N, you really did it!$B$BNow, by my calculations, if we do not get this bucket sailing very very soon, there is the increasing likelihood of one of those giant volcano rocks shooting through the air and smashing the yacht to smithereens.$B$BShall we?'

,`Text0_1_loc9`='What a mess! How am I going to spin this?$B$BAnd really... goblin zombies?!!'
...
,`Text0_1_loc9`='Do you have any idea how much time and moolah you\'ve saved us, $N? This could have been a complete disaster and you\'ve single-handedly saved the entire cartel.$B$BToo bad that you and Thrall spared Gallywix. I think that you would make an excellent Trade $G Prince : Princess;!'
,`Text0_1_loc9`='No one could have done what you did, $N. Why you spared Gallywix is beyond me. You should have had his job.$B$BHere\'s to hoping that setting up our new home in Azshara is uneventful. I\'m looking forward to retiring.'

UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='You did it! We\'re saved!',`Text1_0_loc9`='Are we really finally going to Azshara? Is there a volcano there, too?',`Text1_1_loc9`='Are we really finally going to Azshara? Is there a volcano there, too?' WHERE `entry`=15696;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='How can I ever thank you, $N?',`Text3_0_loc9`='I\'d keep my eyes and ears open if I were you. There\'s a rumor going around that you caused both Mount Kajaro and the Lost Isles volcanoes to explode.$B$BCrazy, I know. But people will gossip about anything and love to tear down their heroes, especially if there\'s a chance for profit and promotion.',`Text3_1_loc9`='I\'d keep my eyes and ears open if I were you. There\'s a rumor going around that you caused both Mount Kajaro and the Lost Isles volcanoes to explode.$B$BCrazy, I know. But people will gossip about anything and love to tear down their heroes, especially if there\'s a chance for profit and promotion.' WHERE `entry`=15696;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Let\'s leave dock before the volcano destroys us all!',`Text5_0_loc9`='Ready to go when you are, $G sir : ma\'am;!',`Text5_1_loc9`='Ready to go when you are, $G sir : ma\'am;!' WHERE `entry`=15696;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='I don\'t know. I think I\'m going to miss this place. We had some pretty good times here.',`Text7_0_loc9`='I have an idea... this time let\'s not wander through a naval battle between the Alliance and the Horde.$B$BI\'m just saying.',`Text7_1_loc9`='I have an idea... this time let\'s not wander through a naval battle between the Alliance and the Horde.$B$BI\'m just saying.' WHERE `entry`=15696;
,`Text0_1_loc9`='May the Earth Mother watch over you, $N. Thank you for your help.'



,`Text0_1_loc9`='Looks like this is it, boss-$G man : lady;. It\'s been a real honor. I\'m sure we\'ll see each other again real soon.'
...
,`Text1_0_loc9`='Al\'tha, Al\'tha bormaz. Ni bormaz ta\'thall? It comes, it walks in flames, $R!'
,`Text3_0_loc9`='Mar\'kowa tallol ye\'tarin, it knows, it knows.'
,`Text5_0_loc9`='We are nothing. Tulall par\'okoth. Far\'al, ka\'kar. The void devours.'
,`Text7_0_loc9`='H\'thon, the column of darkness stretching beyond sight. H\'thon marwol qualar: the infinite grasp of night.'
,`Text0_1_loc9`='$N, the Twilight slaves you and others have been rescuing from Wolf\'s Run are wandering into camp, but they can\'t tell me who they are and they speak in riddles and gibberish.$B$BI thought Twilight\'s Hammer kept the slaves in line the old fashioned way - you know, whips and chains - but it\'s clear that there\'s some brainwashing at work...'
,`Text0_1_loc9`='Any luck out there? Just trying to hold a conversation with the freed slaves makes my head hurt.$B$BThey straddle the line in discord and rhyme.'
,`Text0_1_loc9`='Thanks for your help, $N.'

,`Text0_1_loc9`='The forces of the Sentinel Army hold back the Horde across all of Kalimdor. While the war continues in Ashenvale and Stonetalon, our forces are also needed here, to protect these remaining wilds and prevent our enemies from gaining further footholds.'

,`Text0_1_loc9`='No, I cannot return to Orgrimmar. I grieve for my family, but they have made their choices and I have made mine. My future is here, among my chosen brethren.'
,`Text0_1_loc9`='I will not leave. Tell my family that I am at peace here and that I wish them well.'
,`Text0_1_loc9`='One day, I, too, will ascend.'
,`Text0_1_loc9`='It amazes me that in a city full of people, only the small handful here heeded the warnings of the elements.'


,`Text1_0_loc9`='I\'d lend a hand, but I\'ve got... chain rash. I\'ll just hang back a little.'
,`Text3_0_loc9`='How long was I hanging back there? It felt like days.'
,`Text5_0_loc9`='Ogres.$B$BI hate ogres.'
,`Text7_0_loc9`='Less yap flappin\'. More ogre thwappin\'. Deal?'
...
,`Text0_1_loc9`='I don\'t recognize you. Are you new here?'
,`Text0_1_loc9`='You don\'t belong here, outsider. Leave before you get yourself in trouble.'

,`Text0_1_loc9`='The end of the world nears, $C. There is no need to despair. Hear what I say and what my brethren have to offer.'
,`Text0_1_loc9`='I\'m here to study the ways of the muisek spirits, the wild magic. Witch Doctor Uzeri sent me here to start practicing with the lesser creatures of the forest.'


,`Text0_1_loc9`='Our prayers to Aessina go unanswered. The burning minions of Ragnaros have driven us to the brink. If they are not stopped here, the World Tree will be little more than a stump amidst the conflagration!'
,`Text0_1_loc9`='The strands of life have been severed.$B$BThe dreamers must be avenged.'

,`Text0_1_loc9`='Thank you, $C.$B$BI nearly died out there.'


,`Text0_1_loc9`='Welcome, $C.$B$BHyjal burns and the world I\'ve spent my life protecting is on the brink of oblivion.$B$BTell me: Have you ever heard of Tyrus Blackhorn?'
,`Text0_1_loc9`='A decade ago, a great battle took place here on the summit of Mount Hyjal. Archimonde the Defiler commanded a swarm of demons to march upon the World Tree and claim its power for his own.$B$BHis defeat signaled the end of the Legion\'s invasion of Azeroth... But many of his corrupted supporters remained behind.'
,`Text0_1_loc9`='Yes and no. He may be a demon now, but Tyrus Blackhorn was a night elf once. Like many of his brothers he was wooed and transformed by the promises of power the demonic army whispered in his ear.$B$BHe was captured after his master\'s defeat and imprisoned here on the summit, his immortal form bound by sacred energies.$B$BBut perhaps the dimmest flicker of a soul still burns within him... We must at least reach out to know for sure.'

,`Text0_1_loc9`='I\'m only here in case someone faints. The new recruits get a little excited and occasionally overexert themselves.$B$B...well, that, and sometimes one of the new mechano-tank prototypes explode. Whoops!'
...
,`Text0_1_loc9`='I\'d imagined my first adventure into the ocean as more peaceful and enlightening. Becoming one with nature perhaps?$B$BThere is very little natural about this place. The elements all around us scream for vengeance.'




,`Text0_1_loc9`='All I need to prove myself here are my claws!'



,`Text0_1_loc9`='A lot of work goes into training and caring for our animals, but it\'s all worth it.$B$BI could always use a bit of extra help, though.'

,`Text0_1_loc9`='Lady Shandris is counting on me. I will not fail her.'
,`Text1_0_loc9`='I\'d like to punch that Chip right in the kisser! I\'d also like to kiss that Candy right in the kisser, too!'
...
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Hiya, $G babe : hon;! What\'s this I hear about you and $G Candy : Chip;?',`Text1_0_loc9`='"A great day to tackle the last known Kaja\'mit deposits, right,$N?"',`Text1_1_loc9`='Nice day for digging up the last known deposits of kaja\'mite in the world, wouldn\'t you say, $N?' WHERE `entry`=15831;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Isn\'t it weird how kaja\'mite made us smart thousands of years ago, but it doesn\'t seem to be having any effect on our trolls?',`Text3_0_loc9`='"$N, the idea of ​​producing Kaja-Cola from kaja\'mit is simply brilliant! Probably, now the merchant prince will be afraid that you will take away his title!"',`Text3_1_loc9`='Distilling Kaja\'Cola out of kaja\'mite was a stroke of pure genius on your part, $N. The Trade Prince has got to be worried that you\'re going to take his title!' WHERE `entry`=15831;

,`Text0_1_loc9`='I was once a priestess, but I\'ve always been a scholar. The chance to learn from the Highborne seemed more valuable than practicing strict ignorance.$B$BWhat\'s more most of the apprentices here are youths who came of age during the third war. They need guidance, wisdom...$B$BI only wish those who used to call me friend understood.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Everything is destroyed ...',`Text1_0_loc9`='Water gushed and flooded everything!',`Text1_1_loc9`='Water gushed and flooded everything!' WHERE `entry`=15837;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='You$G owe: must; go to the Thousand Needles and provide assistance. You are welcome!',`Text3_0_loc9`='May Mother Earth protect us.',`Text3_1_loc9`='May Mother Earth protect us.' WHERE `entry`=15837;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Free Wind Outpost is lost. Thousands of Needles are gone.',`Text5_0_loc9`='Why did Mother Earth not save us?',`Text5_1_loc9`='Why did Mother Earth not save us?' WHERE `entry`=15837;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='The Leader of the Horn of the Spirit should soon send help to the Free Wind Outpost.',`Text7_0_loc9`='This is called a cataclysm. What led to such destruction? Why us',`Text7_1_loc9`='This is called a cataclysm. What led to such destruction? Why us' WHERE `entry`=15837;
,`Text0_1_loc9`='Securing this area for the Sentinels will be the final part of our defense of Feralas.'

,`Text0_1_loc9`='The Cataclysm has destroyed Thousand Needles, $C. Will you help us in our greatest time of need?'


,`Text0_1_loc9`='The Grimtotem attacked us by surprise. We\'re barely hanging on here.'


,`Text0_1_loc9`='I thought Runetotem reckless to set up camp right in the middle of this devastation, but I wasn\'t about to let the Arch Druid travel here alone.$B$BHe\'s planning something. Something big.'
,`Text0_1_loc9`='These Grimtotem beasts will soon be sent to their maker!'
...
,`Text0_1_loc9`='Fizzle & Pozzik\'s Speedbarge my sweet patootie! I built this thing! Not them, not Razzeric!$B$BIt should be called Jinky\'s Speedbarge!'
...
,`Text0_1_loc9`='Hey, come on in out of the sun.$B$BCan I get you a drink? Not like I have anything else to do around here.'
...
,`Text1_0_loc9`='You saw$G: saw; what is it huge to ?!'
,`Text3_0_loc9`='How are we going to get out of here?'
,`Text5_0_loc9`='It is only a matter of time for the nagas to find us here.$B$BWhat should we fight against them?'
...
,`Text0_1_loc9`='Hello, $C!$B$BThese poor creatures are giving everything they have to fight the minions of the Twilight\'s Hammer in this dark place.$B$BI\'ve done my best to revive those that have fallen.$B$BIf you need an additional mount, these birds are ready to take wing again. Treat them well!'

,`Text0_1_loc9`='Hi there, $G handsome : gorgeous;. Welcome to the Speedbarge Bar.$B$BWhat\'ll it be?'
,`Text0_1_loc9`='Greetings, $C. I hope you find your accomodations suitable, even in this time of war.'

,`Text0_1_loc9`='The odds appear to be against us, but we cannot falter, $N. We are all that stands between the enemy\'s hordes and Nordrassil.'
,`Text0_1_loc9`='Please, $R.$B$BI don\'t know how much longer I can make it here...'
,`Text0_1_loc9`='The Twilight\'s Hammer is more than an organization to me. It\'s a family.$B$BAs such, I take great care in making sure no unworthy candidates make it past the training phase.'

,`Text0_1_loc9`='Your aid is required, $N. Help us stop the brutish Horde!'
,`Text0_1_loc9`='This heat. This stifling heat.$B$BIt makes me want to hurt things.'
...
,`Text0_1_loc9`='<Though Ysera\'s physical form stands in front of you, her consciousness appears to shift between this world and another.>'
,`Text0_1_loc9`='Have you been to Ashenvale lately? How are things?'

,`Text0_1_loc9`='We Druids of the Talon aren\'t cut out for front-line duty. We\'re aerial spies, infiltrators...$B$BBut occasionally I like to get my talons dirty.'



,`Text0_1_loc9`='Careful, $N! Warlord Roktrog is near. He should be back any minute!'


UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='You\'ll get nothing from me, $R!',`Text1_0_loc9`='<Marion cries out loud and looks at you.>',`Text1_1_loc9`='<Marion squaks loudly and glares at you.>' WHERE `entry`=15982;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Your cities will fall, $R. You\'ll perish in the darkness of the new regime!',`Text3_0_loc9`='You can do anything with me. Just know that my name will be cut out on your body before execution!',`Text3_1_loc9`='Do what you will. My new masters will carve my name into your flesh before they execute you.' WHERE `entry`=15982;
,`Text0_1_loc9`='She asked for eggs. Eggs for her fiery hatchery in another realm.$B$BAnd one egg... a special egg... she sought more than any other.'
,`Text0_1_loc9`='She of the skies, but also of darkness. Brood of the Earth-Warder. Invincible!'
,`Text0_1_loc9`='Foolish $R! There is a new order. Aviana is dead. DEAD! And never coming back.$B$BTell that to the druids in the trees.$B$BSethria will soon be the master of the skies, and she has made sure Aviana will never be reborn. The egg is hers.$B$BYou are too late.'
...
,`Text0_1_loc9`='Welcome to our home away from home, $C. I wish we had a bit more hospitality to offer.'
,`Text0_1_loc9`='Be careful in the vale, $N. Enemies abound!'
,`Text0_1_loc9`='Need to do some shopping?'
...
,`Text0_1_loc9`='The summoning incantations have been prepared, but we were depending on the Crucible of Nazsharin to draw power for our spell. The artifact must be recovered.'
,`Text0_1_loc9`='Mathias Shaw himself appointed me to assist the night elves.'




UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Wha - Where  am I? Are you one of them?',`Text1_0_loc9`='Is it all over yet?',`Text1_1_loc9`='Is it all over yet?' WHERE `entry`=16078;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Must ... return to ... Irontree!',`Text3_0_loc9`='You\'re not from Twilight\'s Hammer. What is happening out there?',`Text3_1_loc9`='You\'re not from Twilight\'s Hammer. What is happening out there?' WHERE `entry`=16078;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='I\'m burned. Badly.',`Text5_0_loc9`='Twilight\'s Hammer... I heard them screaming and running... are we making a counter-attack?',`Text5_1_loc9`='Twilight\'s Hammer... I heard them screaming and running... are we making a counter-attack?' WHERE `entry`=16078;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='The town... demolished! We couldn\'t stop them.',`Text7_0_loc9`='They\'ve opened gateways to the Firelands... tell me there\'s still hope!',`Text7_1_loc9`='They\'ve opened gateways to the Firelands... tell me there\'s still hope!' WHERE `entry`=16078;
...
,`Text1_0_loc9`='We are poorly equipped to do battle here.$B$BPreparations must be made...'
,`Text1_0_loc9`='If we find a way to fight our way out of here, Hellscream will know of your deeds, $R.'
...
,`Text0_1_loc9`='These lands are the frontier of the Dark Lady\'s conquest, $N. Look upon them; in time, it shall all be in the grasp of the Forsaken.'



,`Text0_1_loc9`='Yes, Battlemaiden?'
...
,`Text0_1_loc9`='Victory for Sylvanas! These lands will be ours.'


,`Text0_1_loc9`='Someone is using these beakers and alchemy tools to perform experiments with various types of submarine fuel.'

,`Text0_1_loc9`='Several small samples of oil sit in front of you, along with an empty beaker. The beaker looks like it can probably fit about five samples inside of it.$B$BWhat kind of oil will you take first?'
,`Text0_1_loc9`='What type of oil will you select next?'
,`Text0_1_loc9`='You now have two samples of oil. Which sample will you select next?'
,`Text0_1_loc9`='You now have three samples. Which sample will you select next?'
,`Text0_1_loc9`='You have four samples, and only have room to test one more. Which one will it be?'
,`Text0_1_loc9`='You have selected all five of your samples.'
,`Text0_1_loc9`='You can use these beakers and alchemy tools to perform experiments with various types of submarine fuel.'
,`Text0_1_loc9`='You have discovered a new type of bio-fuel!  Bring it to Engineer Hexascrub for testing.'
,`Text0_1_loc9`='You have discovered a new type of bio-fuel!  Bring it to Fiasco Sizzlegrin for testing.'



,`Text0_1_loc9`='Why are they doing this?  For pearls?  For war?  This ancient, Nespirah, is far more powerful than the naga understand. If they\'re able to turn her towards their will... the damage they could cause would be tremendous.'

,`Text0_1_loc9`='I don\'t like the feel of this place, $N. Naga sorceresses and slavedrivers aside... all I can sense inside this cavern is pain. The ancient one is trying to cry out, but it cannot speak.'
...
,`Text0_1_loc9`='Cooking for the King is an honor, not a job. Do you have time to help me on some errands?'
,`Text0_1_loc9`='The end of Operaton: Gnomeregan meant a chance to rest for most people. However, my assistants and I have been caring for the wounded and for the survivors that the S.A.F.E. teams rescue from inside the city.'
...
,`Text0_1_loc9`='Greetings, $N. I can offer you training in the way of the mage.'
,`Text0_1_loc9`='I\'m sorry, $C, I cannot help you. You\'ll have to find a $C trainer.'
,`Text0_1_loc9`='I\'m sorry, I can\'t offer you training. You\'ll have to find someone more familiar with your skills.'
...
,`Text0_1_loc9`='You ask me, I think we let the soup and gravy take care of this ready and write.$B$BIt\'s bird lime to kick and prance ourselves out of here before we\'re all brown bread.$B$BCatch my meaning, love?'
,`Text0_1_loc9`='Just between you and me, hon, I\'m too short to pull this kind of duty. One more month and I\'m out.$B$BI\'ve already died once. No sense doing it a second time.'
,`Text0_1_loc9`='Dealing with the first ancient, Nespirah, was hard enough. The one across from us, L\'ghorek, is dying.$B$BI can sense its cries of agony. Something is stealing its life force. But to what end?'
,`Text0_1_loc9`='I wish that I was going to fight by your side in the upcoming battle, but Erunak wants me to remain here.$B$BGood luck, $N.'
,`Text0_1_loc9`='These depths truly are a nightmare.$B$BAlthough, the battle that is about to be joined down in the breach below will make this look like kittens and rainbows.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Whaddya want?',`Text1_0_loc9`='I ain\'t tellin\' you nothin\'!',`Text1_1_loc9`='I ain\'t tellin\' you nothin\'!' WHERE `entry`=16250;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Get lost.',`Text3_0_loc9`='Oh the big hero has arrived. I\'m saved! Yea, right...',`Text3_1_loc9`='Oh the big hero has arrived. I\'m saved! Yea, right...' WHERE `entry`=16250;
,`Text4_1_loc9`='You wanna talk? Pay up.'

,`Text0_1_loc9`='Feeding a Horde army is no easy task. I have lots to do, do you have time to help?'
,`Text0_1_loc9`='We must do whatever it takes to recombine the fragments of the World Pillar.$B$BBut first, we must regain all of them.'




,`Text0_1_loc9`='The trolls here are quite accepting of my kind. After all, they spoke to the dead for centuries before the Forsaken even existed.$B$BIt\'s good for business.'
,`Text0_1_loc9`='In my youth, my family did not approve of my interest in shamanism. Brash and foolish as I was, I ran away from them and practiced on my own. Upon returning to my home one day, I found my parents gone. My home destroyed. They never found who did it.$B$BI\'ve spent my life striving to extend my shamanistic visions to see into the past - to find out what happened to my family and who is responsible. I\'ve come a great way. I\'ve learned to focus in on impactful events in the recent past, but I have much further to go if I ever hope to glimpse something that occurred so long ago.'
...
,`Text0_1_loc9`='No matter what\'s going on elsewhere, Ironforge hasn\'t forgotten this land, nor any of Khaz Modan.'

,`Text1_0_loc9`='If you need a mountain moved, I can do that. I can make \'em for you, too.'




,`Text0_1_loc9`='Priestess knows much about Zul\'Gurub.$B$BPriestess thinks you need her help.'
...
,`Text1_0_loc9`='Stranglethorn, $G man: babe;. That\'s where it\'s AT!'
,`Text3_0_loc9`='Ah, to be back in Stranglethorn. The screeching raptors, the troll wars, jungle creatures as far as the eye see, just ASKING to be killed...$B$B<Bort sighs.>'


,`Text0_1_loc9`='Prepare for war! We will no longer tolerate the Vilebranch!'

,`Text0_1_loc9`='Ready for a tussle, $Glad:lass;?'
...
,`Text0_1_loc9`='There\'s more to this than we know, $N. I can guarantee you that much.'
,`Text0_1_loc9`='"Welcome to Kofelnagel Shelter!$B$BDo you want to escape from the hustle and bustle of city life? You got$G: hit; where you need to!$B$B Do you want to see first hand the wonders of the famous Azeroth jungle? Just look around!$B$B Would you like to refuel with cheap biofuels or buy mineral oils for weapons? Then you are there, | 3-6 ($C)!"'
...
,`Text0_1_loc9`='World-famous Noggenfogger Elixir sold here!$B$BHome brewed from all-natural ingredients, bottled and sold locally right here in Gadgetzan. And it\'s delicious, of course!'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='I can\'t do business with you, $C. Warchief\'s Orders.',`Text1_0_loc9`='I have nothing I\'m allowed to sell to you.',`Text1_1_loc9`='I have nothing I\'m allowed to sell to you.' WHERE `entry`=16425;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Get lost, $C! I don\'t want the enforcers to see me doing business with you...',`Text3_0_loc9`='Go away, I don\'t want the Warchief to find out I\'ve been talking to the Horde.',`Text3_1_loc9`='Go away, I don\'t want the Warchief to find out I\'ve been talking to the Horde.' WHERE `entry`=16425;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='My goods aren\'t for sale to the Horde. Don\'t like it? Take it up with the Warchief!',`Text5_0_loc9`='Warchief Mor\'ghor ordered us not to do business with the Horde.$B$B<The merchant spits on the ground, infuriated, but refuses to speak any more on the subject.>',`Text5_1_loc9`='Warchief Mor\'ghor ordered us not to do business with the Horde.$B$B<The merchant spits on the ground, infuriated, but refuses to speak any more on the subject.>' WHERE `entry`=16425;




,`Text1_0_loc9`='Warchief Mor\'ghor runs the show here. Don\'t forget it.'
,`Text3_0_loc9`='The fury! The power! I have never felt so strong in all my life.$B$BSoon, ALL the Dragonmaw will feel as I do.'
,`Text5_0_loc9`='Warchief Mor\'ghor will make the Dragonmaw great again!$B$BWe have no need for your pathetic Horde.'

,`Text0_1_loc9`='This stone trogg is behind the growth in the Crimson Expanse.$B$BI sense a strange power in this place... be careful.'
...
,`Text1_0_loc9`='Avast!'
,`Text3_0_loc9`='Yarr!'
,`Text5_0_loc9`='Gangway!'

,`Text1_0_loc9`='Have you come to help overthrow Mor\'ghor?'
,`Text3_0_loc9`='Don\'t give me any armor. Just gimmie a blade and tell me who to kill.'
,`Text5_0_loc9`='I\'ll fight by your side, $C. You won\'t regret helping us!'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Looks like I picked the wrong day to stop killin\' fel orcs.',`Text1_0_loc9`='It\'s a day of reckoning, $C!',`Text1_1_loc9`='It\'s a day of reckoning, $C!' WHERE `entry`=16471;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Put me in, coach! I\'m ready to fight!',`Text3_0_loc9`='Today Mor\'ghor\'s tyranny will end.',`Text3_1_loc9`='Today Mor\'ghor\'s tyranny will end.' WHERE `entry`=16471;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='This is it, $C! The revolution has come.',`Text5_0_loc9`='$C! Zaela said the Horde would provide us with weapons. What do you have?',`Text5_1_loc9`='$C! Zaela said the Horde would provide us with weapons. What do you have?' WHERE `entry`=16471;
...
,`Text0_1_loc9`='What shall the Light teach you?'
,`Text0_1_loc9`='The Light protect you, $C.'
,`Text0_1_loc9`='The light of the Sun illuminates the path to wisdom. Where shall we walk today, friend?'
,`Text0_1_loc9`='May the Sun\'s light protect you, $C.'

,`Text0_1_loc9`='The dead cry for solace. Their anguish echoes on the wind.'
UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=16500;

,`Text0_1_loc9`='The blessing of the land be with you.'



Text0_1_loc9`='Welcome to Dolanaar, $C. Let me know if you need any recipes or basic cooking ingredients.'
,`Text0_1_loc9`='I hope you weren\'t looking for something to eat, $C.'
,`Text0_1_loc9`='You are not yet strong enough to enter The Battle for Gilneas. Return when you have gained more experience.'

,`Text0_1_loc9`='You are not yet strong enough to do battle in Twin Peaks. Return when you have gained more experience.'
...
,`Text0_1_loc9`='I train only warriors, $C. You\'ll have to look elsewhere.'
,`Text0_1_loc9`='Are you ready to train, warrior?'


,`Text0_1_loc9`='We will defeat the Twilight\'s Hammer wherever they may hide. Not even the elemental planes will be a safe haven for their kind.'

,`Text0_1_loc9`='Hello, $C. Care to purchase something?'
,`Text0_1_loc9`='The Gurubashi are dead, and Hakkar with them. Most of my fellow Zandalar have returned to their homeland.$B$BIt falls on me, Chabal, and the Darkspears of Bambala to watch over Zul\'Gurub now.'
...
,`Text1_0_loc9`='Orgrimmar is stronger than ever!'


,`Text1_0_loc9`='I don\'t know nothing! Ask the others.'
,`Text3_0_loc9`='Secret cult? You\'re not with those creepy orcs who lurk around the south zeppelin tower, are you?'
,`Text5_0_loc9`='I hear strange orcs whispering all the time inside the south zeppelin tower. They always shut up whenever I get near.'

,`Text0_1_loc9`='I\'m sorry, but I can\'t offer you training.'
,`Text0_1_loc9`='Choosing the path of a mage is to choose a path of great difficulty. Many do not understand us. Our own people struggle to accept our arts.'
,`Text0_1_loc9`='Are you here to help Ironforge, or just gawk at me all day?'


,`Text0_1_loc9`='"If you need a rest, I have a free bed. Not too comfortable, but, apparently, you will not have to sleep on it for a long time."'
,`Text0_1_loc9`='I cannot help you with your training. Seek out a $C trainer.'
,`Text0_1_loc9`='Are you here to train, hunter?'


,`Text0_1_loc9`='Are you here to train in Archaeology?'
,`Text0_1_loc9`='Welcome to Nethergarde, $C. Call me "Mama," I\'m here to take care of you.'
,`Text0_1_loc9`='In death, we are reborn.'



,`Text0_1_loc9`='It\'s an honor to have a hero like you among us, $N.'

,`Text0_1_loc9`='The druids and sentinels prefer to keep separate company, but we have always worked well together.$B$BNever mistake privacy for aversion.'
,`Text0_1_loc9`='A beautiful city, is it not? As was Gilneas, in its time.$B$BBut such things pass, as shall we. Only the earth and her secrets will remain.$B$BAre you willing to learn, $N?'



,`Text0_1_loc9`='Begone. I have neither the ability nor the inclination to instruct you.'
...
,`Text0_1_loc9`='There are two: The Trader\'s Hall in the Trade District, and the Stormwind Auction House in the Dwarven District.'
,`Text0_1_loc9`='You\'ll find it in the northernmost part of the Dwarven District, near the Northern Landing.'
,`Text0_1_loc9`='There are two banks in the city: The Stormwind Counting House in the Trade District, and the Royal Bank of Stormwind in the Dwarven District.'
,`Text0_1_loc9`='Stormwind\'s Royal Bank is in the northernmost corner of the Dwarven District, just inside the Northern Landing.'
,`Text0_1_loc9`='Stormwind\'s two most popular inns are located in the Trade and Dwarven Districts: The Gilded Rose and The Golden Keg.'
,`Text0_1_loc9`='The Golden Keg is in the northen part of the Dwarven District, right by the fountain.'
,`Text0_1_loc9`='Stormwind has many points of interest, from the Deeprun Tram to Stormwind Keep.$B$BWhat were you looking for?'
,`Text0_1_loc9`='There are stable masters in both Old Town and the Dwarven District.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Byron Oakhorn can be found in earternmost Stormwind, through the gates at the back of Old Town.',`Text1_0_loc9`='If you need to house your pet while you\'re training another, then you should talk to Jenova Stoneshield over in the Dwarven District.',`Text1_1_loc9`='If you need to house your pet while you\'re training another, then you should talk to Jenova Stoneshield over in the Dwarven District.' WHERE `entry`=16609;
,`Text0_1_loc9`='There were too many... our assault seems to have barely even scratched at their ranks. We lost so many men! Something must come of this...'





,`Text0_1_loc9`='There are hunters training in Old Town\'s Command Center as well as in the Dwarven District.'
,`Text0_1_loc9`='You can always find a handful of hunters just outside Old Town\'s east gate.'
,`Text0_1_loc9`='The Park...?$B$BIt\'s in ruins. Haven\'t you heard? The great dragon Deathwing soared over Stormwind and destroyed it in passing.$B$BNot sure why he didn\'t level everything, honestly, but we all thank the Light he didn\'t.'
,`Text0_1_loc9`='The keep is in northren Stormwind.$B$BJust follow the canals north and you\'ll eventually come across a drawbridge... that leads into the keep\'s courtyard.'
,`Text0_1_loc9`='The prison? Why would you want to go there? It\'s in the center of the city, just northeast of the Mage Quarter.$B$BIf you\'re truly going there, be careful. I\'ve heard news of riots.'
,`Text0_1_loc9`='I\'m sorry, I cannot train you.'
,`Text0_1_loc9`='How can I help you, $C?'
...
,`Text0_1_loc9`='Denman Family Jewelers, between the northern Trade District and The Canals, should have everything you\'re looking for.'
,`Text0_1_loc9`='Harrison Jones teaches Archaeology in Stormwind Keep\'s Royal Library when not out in the field.'
,`Text0_1_loc9`='Profession vendors can always be found near their respective trainers. Other sorts of vendors are scattered throughout Stormwind.$B$BWhat were you looking for?'
,`Text0_1_loc9`='The Champions\' Hall is located in the southeastern end of Old Town.$B$BThe Honor and Conquest quartermasters can be found there.'
,`Text0_1_loc9`='In the Command Center, just outside of Old Town\'s southeast gates, you\'ll find the quartermasters.'
,`Text0_1_loc9`='There are stables just beyond Old Town\'s southeast gates. You can find a riding trainer and a horse breeder there.'

,`Text0_1_loc9`='Do you know of the Gryphon Roost off the Trade District, where the Flight Master may be found?$B$BA pair of Wildhammer dwarves raises and sells gryphons there, and can even train you to ride the beasts.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='You look exhausted. Is something wrong?',`Text1_0_loc9`='Good to see you.',`Text1_1_loc9`='Good to see you.' WHERE `entry`=16635;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Any luck with Therazane?',`Text5_0_loc9`='You look intent. Is there something I can help with?',`Text5_1_loc9`='You look intent. Is there something I can help with?' WHERE `entry`=16635;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='Am I needed?',`Text7_0_loc9`='And I thought I might get a bit of rest. Silly me.',`Text7_1_loc9`='And I thought I might get a bit of rest. Silly me.' WHERE `entry`=16635;
...
,`Text0_1_loc9`='Hi. Welcome to my salon.$B$BYou look great! But if you\'re in the mood for a change, speak with my barber, Jelinek, or just sit right down in one of the chairs.'

,`Text0_1_loc9`='We must take what is ours. Our survival depends on it.'



,`Text0_1_loc9`='We\'re trying to find out what\'s so important up at the Masters\' Gate.$B$BI just know that those Hammer jerks are up to no good. No fair! We came all this way following a clue and now we can\'t even get close.'
,`Text0_1_loc9`='I am the mistress of the skies, and they who threaten my children shall suffer.'
,`Text0_1_loc9`='Call me Twin. That\'s what Mowi calls me.$B$BNo, we don\' look alike. Are ye blind? She\'s a gnome fer the Light\'s sake! We act alike. \'specially when we\'re fightin\'.$B$BAs fer my name... have ya na heard o\' the storied Wildhammer Brewers? Care fer a pint?'
,`Text0_1_loc9`='The Twilight\'s Hammer has most certainly uncovered something of interest up at the Masters\' Gate.$B$BPerhaps a $G skilled : lovely; $C such as yourself would help me with that?'



,`Text0_1_loc9`='What brings you inside these cursed lands?'

,`Text1_0_loc9`='I saw the Wastewander and their leader, Caliph Scorpidsting, heading south of here. Watch out, they look like they\'ve toughened up some!'
,`Text3_0_loc9`='I don\'t know much about dragons, but a big, scary one showed up one day just over yonder, near the entrance to the Caverns of Time. He kept yelling something about...what was it...the end of time as we know it?  I wasn\'t really paying much attention.'
,`Text5_0_loc9`='I found a broken-down cart amongst the dunes when I was checking out the potential profitibility of Centipaar Silithid Snacks (patent pending). I thought to myself, "hey, free cart!"  That is, until the biggest basilisk you\'ve ever seen showed up, and I had to leave the whole thing behind!'
,`Text7_0_loc9`='When the Cataclysm happened, the links bounding elementals across Azeroth weakened significantly. One such elemental, Aquementas, is no longer imprisoned. I hear he\'s causing some major problems for the Southsea gang!'

,`Text0_1_loc9`='How do you do, $N?'

,`Text0_1_loc9`='I\'ll burn this place to the ground before I am shamed in the eyes of Hellscream!'
,`Text0_1_loc9`='$N!  I hope you\'re ready to get to work, because there is much for you to do here on Sunstrider Isle.$B$BEver since the destruction of the Sunwell by Arthas and the Scourge, we have been a race adrift on a sea of uncertainty. We teeter on the edge of oblivion. This will change, $C, and you will learn and aid our recovery at the same time.$B$BThe Outland awaits us!'
,`Text0_1_loc9`='I can instruct you in blacksmithing as well as supply the necessary tools.$B$BHow may I help you?'
,`Text0_1_loc9`='I can instruct you in herbalism as well as offer helpful supplies.$B$BHow may I help you?'


,`Text0_1_loc9`='How may I be helpin\' ya, Child of de Earth?'
,`Text0_1_loc9`='Dark is de jungle, but fertile is its soil.$B$BMay de spirits of de earth watch over ya, $C.'
...
,`Text0_1_loc9`='Deathwing\'s taint shall be wiped from Deepholm, and his Twilight cultists with it.'





,`Text0_1_loc9`='Come in, mon... forget yer cares for a while!$B$BRest de body, rest de soul.'
,`Text0_1_loc9`='The materials I offer are rare and powerful.'



,`Text1_0_loc9`='Just look at this place!$B$BIt\'s an archaeologist\'s dream...'


,`Text0_1_loc9`='Keep starin\', I don\'t get any prettier.'

,`Text0_1_loc9`='De secrets I have ta share would blast your soul apart, $C.$B$BTrust me: You be wantin\' ta talk ta someone else about trainin\'.'
,`Text0_1_loc9`='Who knows what dark an\' horrid tings be gibberin\' in de outer darkness... tings dat\'d drive a soul mad ta see?$B$B-We- be knowin\'. An\' you\'ve come lookin\' ta know -more,- haven\'t ya?'
,`Text0_1_loc9`='Greetin\'s, $N. Are ya here ta be learnin\' of de Hidden Arts?'


UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=16756;

,`Text0_1_loc9`='Hello there, $C!'
,`Text0_1_loc9`='Well, let\'s see. I heard that Magus Bisp has been spending his time cooped up on top of his tower, working on some new spell, or something.$B$BI heard that Del Gahrron was planning on retiring and heading back to his farm. He may have already left, in fact.$B$BOh, and I heard that there\'s some $R $C running around town, asking people all sorts of annoying questions!$B$BJust playing with you, love. Hope that information helped.'



UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='<Grunt>$B$BYou need something, $R?',`Text1_0_loc9`='What is it?  I\'m a little busy here.',`Text1_1_loc9`='What is it?  I\'m a little busy here.' WHERE `entry`=16763;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='I\'m training right now. Can this wait?' WHERE `entry`=16763;
UPDATE `locales_npc_text` SET `Text2_1_loc9`='I\'m training right now. Can this wait?', `Text3_0_loc9`='Yes?',, `Text3_1_loc9`='Yes?' WHERE `entry`=16763;



,`Text0_1_loc9`='How may I assist you in the afterlife?'
,`Text0_1_loc9`='How may I assist you in the afterlife?'

,`Text0_1_loc9`='Glad to have a chance to catch my breath. Thanks for the help!'

,`Text0_1_loc9`='Good to see you again! Thanks for the hand. I\'ll be back on my feet in just a moment.'


,`Text1_0_loc9`='Gory just happy to be in the sun.'
,`Text3_0_loc9`='Gory not very good at planting, but Gory VERY good at reaping.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='You take a wrong turn, mon? Heh heh heh.$B$BWhat can I be helpin\' ya find?',`Text1_0_loc9`='Don\'t see many a\' your kind \'round here, mon.$B$BWhat can I be helpin\' ya find?',`Text1_1_loc9`='Don\'t see many a\' your kind \'round here, mon.$B$BWhat can I be helpin\' ya find?' WHERE `entry`=16783;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Don\'t see many a\' your kind \'round here, mon.$B$BWhat can I be helpin\' ya find?',`Text1_0_loc9`='Don\'t see many a\' your kind \'round here, mon.$B$BWhat can I be helpin\' ya find?',`Text1_1_loc9`='Don\'t see many a\' your kind \'round here, mon.$B$BWhat can I be helpin\' ya find?' WHERE `entry`=16784;


,`Text0_1_loc9`='"Wow, friend.$B$B Do you want to stall your horse or are you looking for a missing pet?"'
,`Text0_1_loc9`='Hey der, mon.$B$BDid ya need help recoverin\' a lost companion?'
,`Text0_1_loc9`='Sorry, $C.$B$BI ain\'t believin\' ya got de right mind for graspin\' de nature of portal magic.'
,`Text0_1_loc9`='"Hi friend.$B$BIf you are ready, I can show you how to create a portal to return to this place ..."'
,`Text0_1_loc9`='De auction house and bank be at de top of de tall building in de middle of de valley, mon.$B$BLook for Ziji and Makavu.'
,`Text0_1_loc9`='You be wantin\' Sijambi, mon.$B$BShe be in de tall building in de middle of de valley.'
,`Text0_1_loc9`='Right outside de valley\'s inn, mon.$B$BIt be de tall building in de middle.'
,`Text0_1_loc9`='Which ya be lookin\' for?'

,`Text0_1_loc9`='You be lookin\' for Sesebi, mon.$B$BShe most often be sleepin\' under de tree by old Umbehto, de fisherman, lookin\' like a big ol\' tiger.'
,`Text0_1_loc9`='Kuzari and Zanga are trainin\' headhunters on one of de small islets towards de southeast end of de valley, mon.'
,`Text0_1_loc9`='Dey be on top of de tall building in de southeast end of de valley.'

,`Text0_1_loc9`='Shadow-Walker Zuru can help ya.$B$BYou\'ll find him on de lowest floor of de taller building in de southeast.'
,`Text0_1_loc9`='Ku\'nanji, de Night-Stalker, is who yer lookin\' for.$B$BHe be just north of de valley\'s central building.'
,`Text0_1_loc9`='Witch Doctor Umbu spends his time walkin\' about de valley, tendin\' to de people and elemental spirits alike.$B$BLook for him around de central building.'
,`Text0_1_loc9`='You be crazy, mon, meddlin\' with dat bad mojo. But I ain\'t one ta stop ya.$B$BUnjari Feltongue is in de taller building in de southeast, past de shadow priest\'s shrine.'
,`Text0_1_loc9`='Zamja be de best cook in Orgrimmar, mon.$B$BYou can find her just south of de valley\'s central building. Batamsi sells de food Zamja makes, too, if ya just be hungry.'
,`Text0_1_loc9`='Jandi and Zeal\'aya work from a hut just north of de valley\'s central building.$B$BDey can help ya wit\' whatever ya need, mon.'
,`Text0_1_loc9`='Old Umbehto be on a lil\' islet east of de valley\'s central buildin\'.'
,`Text0_1_loc9`='Huju and Xen\'to can take care of ya.$B$BFind dem in de valley\'s central building, mon.'

,`Text0_1_loc9`='Xan\'tish and his snakes are slitherin\' around de valley\'s central building, mon.'
,`Text0_1_loc9`='They attacked us when the waters rushed in! It was almost as if they knew what was going to happen.$B$BThey should all suffer for what they\'ve done.'

,`Text0_1_loc9`='I cannot offer ya trainin\', friend.'
,`Text0_1_loc9`='Welcome ta Moonglade, $C. All be welcome \'ere, as long as ya be keepin\' the sacred peace.'



,`Text0_1_loc9`='These are grave times for Azeroth, $N.'
,`Text0_1_loc9`='<The Stonemother stares down at you. Through you. As if she\'s peering into your soul.>$B$BMy daughter, Theradras, sequestered herself deep within the Crystal Caverns of Terramok to grieve for her lost love, Zaetar. There, heartless, stoneless beings invaded and slaughtered her amidst her mourning.$B$BIf I had any reason to trust a creature afflicted by the curse of flesh, it was stripped from me that day. And yet in your arrogance, you persist.$B$BOne day, you will outlive your usefulness.'


,`Text0_1_loc9`='How can I help ye, $C?'
,`Text0_1_loc9`='Nay, but ye can talk ta Earthmender Doros over there... the big draenei, lookin\' over what\'s left o\' the Twilight camp.'
...
,`Text0_1_loc9`='Where are those lunkheads?'


UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='I cannot promise that your rest will be peaceful, $C. These orcs do not know when to quit.' WHERE `entry`=16851;
UPDATE `locales_npc_text` SET `Text0_1_loc9`='I cannot promise that your rest will be peaceful, $C. These orcs do not know when to quit.', `Text1_0_loc9`='A drunk orc is  a sight to see. An army of drunk orcs is a sight I wish to never see again.',, `Text1_1_loc9`='A drunk orc is  a sight to see. An army of drunk orcs is a sight I wish to never see again.' WHERE `entry`=16851;
,`Text2_1_loc9`='If my mother had told me there would be days like this I would not have believed her.'

,`Text0_1_loc9`='No thanks! Maybe another time. In another life. Not today - for sure.'





,`Text0_1_loc9`='Do you need to return to Vashj\'ir?'

,`Text0_1_loc9`='You and your coin are -always- welcome here.'

,`Text0_1_loc9`='She\'s hung up in the debris and I\'ve lost steam pressure. This terrain is murder!$B$BCan you get us out of this?'


UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=16875;
UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=16876;

,`Text0_1_loc9`='No offense, but you don\'t look like you could shoot the broad side of a pack kodo.$B$BHow about we stop wastin\' each other\'s time and you go find the right trainer.'
,`Text0_1_loc9`='Yo. Up for a little target practice?'
,`Text0_1_loc9`='Hey there, $N. Here for a lesson? I ain\'t got all day...'

,`Text0_1_loc9`='Nothin\' ta see here, mon. Be on yer way, why don\'cha?'
,`Text0_1_loc9`='I heard ya comin\' a league away, mon. Maybe ya need some more trainin\'?'
,`Text0_1_loc9`='What?  I look like a $C to you?$B$BGet outta here, will ya?'
,`Text0_1_loc9`='You need somethin\'?$B$BToo bad. I got nothin\' for ya, $C.'
,`Text0_1_loc9`='"Controlling the Elements for Fun and Profit."$B$BThat\'s what it\'s all about, am I right?  Let\'s get ta work.'
,`Text0_1_loc9`='Look. You don\'t even WANNA know the sorta stuff I could teach ya.$B$BSeriously. It\'d melt yer brain. Go play nice somewhere else.'
,`Text0_1_loc9`='You gotta love fel energy: Cheap, renewable, and guaranteed to blow things up.$B$BSure, you risk losin\' your eternal will to Unimaginable Horrors from Beyond Time and Space, but hey, risk versus reward!$B$BNow, what did you wanna see me about, hmmm?'




,`Text0_1_loc9`='You won\'t find a finer firearm anywhere else in Orgrimmar.'
,`Text0_1_loc9`='We have pledged to open an elemental gateway from Stormwind to the Highlands, but interference from the Bastion of Twilight hampers our efforts.$B$BWhat madness are they engaged in over there?'
,`Text0_1_loc9`='The portal has been opened! Thanks to your efforts, we can now quickly travel from Stormwind to Twilight Highlands.'
...
,`Text0_1_loc9`='Lady Windrunner herself sent me to serve as the Horde liaison to Zaela and the Dragonmaw clan. She and the new Warchief, Garrosh, are attempting to mend their broken fences, it would seem.$B$BIn any case, we must put an end to the Twilight threat once and for all. Most importantly, though, we must keep Cho\'gall from creating his ultimate weapon.'

,`Text0_1_loc9`='I\'ve been watching the Dark Iron for a long time...plotting, hoping, wishing for the chance to drive them away and take back my land.$B$BThey can keep Blackrock Mountain. I hope it erupts again and takes them all with it. I want what is now called the Burning Steppes, my part of the Redridge Mountains that their fiery overlord destroyed.$B$B$C, I\'m going to show the world the potential left in my land. I\'ll build a kingdom of peace and justice atop the death and trickery they leave behind them. My vigil is over. I\'m here to fight for what\'s rightfully mine.$B$BAnd I\'m willing to die for it.'


,`Text0_1_loc9`='This stronghold is fortified, but our enemies close in from all sides. We would be wise to secure our position on the coast before advancing farther inland.'

,`Text0_1_loc9`='Looks like they found their way back home. I\'m relieved.$B$BYou came back, too!  Are you interested in joining us?'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='I\'d like to set up shop in Light\'s Hope Chapel someday. I\'m not much of a fighter, but that doesn\'t mean I can\'t help the cause.',`Text1_0_loc9`='"The guys and I have been traveling together for a very short time, but I can\'t imagine myself without any of them."',`Text1_1_loc9`='The boys and I have only traveled together for a little while, but I already can\'t imagine life without either one of them.' WHERE `entry`=16946;
,`Text2_1_loc9`='I hope you\'ve made yourself welcome to the items inside my caravan. If we\'re not using them, you might as well borrow them.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Why would he run off like that?!',`Text1_0_loc9`='"Promise me you\'ll find him,$N."',`Text1_1_loc9`='Promise me you\'ll find him, $N.' WHERE `entry`=16947;
,`Text2_1_loc9`='<Fiona is rather upset. She doesn\'t seem to be in the mood to talk.>'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Good to see you again, $N!',`Text1_0_loc9`='Hey$N! What do you need - just take a look or still buy something?',`Text1_1_loc9`='Hey, $N!  You here to visit, or did you want to buy something?' WHERE `entry`=16948;
,`Text2_1_loc9`='Well, well... look who\'s here!'
...
,`Text0_1_loc9`='Even in these bright days after the reign of Kel\'thuzad, after the fall of the Lich King: the Brotherhood lives on.'


,`Text0_1_loc9`='The Highborne have returned, and with them spellcraft lost to the world for centuries.$B$BDo you have something for me to examine?'
,`Text0_1_loc9`='Arcane Reforgers can modify the magical effects of a item; this magically complex process is known simply as reforging.$B$BThrough reforging, a secondary attribute of any piece of weaponry, armor, or jewelry may be reduced in order to add an additional secondary attribute. In this manner one may customize their equipment to best match their role and skills.$B$BFor example, if an item afforded you a bonus to strike your enemies but you\'d rather it made you attack more quickly, an Arcane Reforger could, for a price, reforge the item to have less Hit Rating but increase your Haste Rating.'
,`Text0_1_loc9`='If you\'re looking for an Arcane Reforger, there is a highborne mage inside the enchanting shop just outside the Mage District.'
,`Text0_1_loc9`='Let\'s get something straight, $R. I\'m here for just one thing: to kill Cho\'gall!$B$BYour job is to keep him from finishing the creation of his ultimate weapon. It\'s an artifact that\'s supposedly being created with the power of an Old God.'


,`Text0_1_loc9`='Poor dear, you must be exhausted.$B$BThere\'s food and drink, if you like, and it\'s safe to rest here.'
,`Text0_1_loc9`='Looking for something to eat, $C?$B$BOr just a place to rest your weary bones for a while?'



,`Text0_1_loc9`='Yo.$B$BYou here to stable your pets, or lookin\' for a lost companion?'
,`Text0_1_loc9`='Yo.$B$BYou lookin\' for a lost companion?'


,`Text0_1_loc9`='I salvaged what I could from the nearby wreckage, but I can only stay down for so long...'
,`Text1_0_loc9`='You ally yourself with these fiends? You, too, shall someday burn!'
,`Text3_0_loc9`='<The ferocious black drake strains at the chains that bind it. It\'s best to keep your distance.>'


,`Text0_1_loc9`='I\'ve been mixing potions since before the cartel wars, and I don\'t plan to stop anytime soon.$B$BAs long as there\'s a buyer to be had, Ol\' Baba will be ready with a sale!'
...
,`Text0_1_loc9`='Ah... I do not have many visitors here.$B$BPlease, sit a while.'

,`Text0_1_loc9`='Are you here to help the cause? Mount Hyjal burns!'


,`Text0_1_loc9`='Dad lets me shoot things!'



,`Text0_1_loc9`='This dwarf\'s body is severely battered. The Twilight\'s Hammer must take pleasure in their killing.'

,`Text0_1_loc9`='The Dunwald family is built tough, but they let it go to their heads. I worry that me brothers put their repuation to the test a wee bit too often.'

UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='I may be restrained now, but my master will set me free when his vengeance rains down upon this city.',`Text3_0_loc9`='I am on the path to ascension and no petty, aspiring hero is going to stop me.',`Text3_1_loc9`='I am on the path to ascension and no petty, aspiring hero is going to stop me.' WHERE `entry`=17057;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='It is your life that will end soon; mine is just beginning.',`Text5_0_loc9`='By the time you realize the truth, it will be too late.',`Text5_1_loc9`='By the time you realize the truth, it will be too late.' WHERE `entry`=17057;

,`Text0_1_loc9`='<The console whirrs and buzzes as you approach it.>'




,`Text0_1_loc9`='Greetings.'
,`Text0_1_loc9`='We\'re glad to see you here again, $N. With so many of our brethren seized by the Warchief\'s forces, we thought we\'d never see you again.'

,`Text0_1_loc9`='After the fall of the Burning Blade Clan, we blademasters swore to free ourselves and our people from demonic control.$B$BThis may be done, but my honor remains unsatisfied.$B$BI shall fight for the Horde - and train other warriors to do so - until I die gloriously in battle. This is the only path I may tread.'
,`Text0_1_loc9`='After the fall of the Burning Blade Clan, we blademasters swore to free ourselves and our people from demonic control.$B$BThis may be done, but my honor remains unsatisfied.$B$BI shall fight for the Horde - and train other warriors to do so - until I die gloriously in battle. This is the only path I may tread.$B$BSo. Are you ready to train?'
,`Text0_1_loc9`='Guarding the bank and treasures of the Horde is far more satisfying than dispensing coins and trade goods from inside a cage of iron.$B$BI would not exchange places with one of those quill-pushing goblins for a moment.'
,`Text0_1_loc9`='The Twilight\'s Hammer invaded these once-pristine waters, and the surrounding lands, a short time ago.$B$BThey have polluted my loch and I would have them gone so that I may purify it once more.'
,`Text0_1_loc9`='This land is where orcs and humans first spilled each other\'s blood. Not a mile south lurks Stonard, where the orcs first grouped to invade our lands.$B$BIt was here they amassed their armies before we even knew they existed. It was here that they started the first of three wars with their attack on a small Alliance town to the west.$B$BMy town. The town where my parents died to save me.$B$BBut I\'m not here to settle a grudge... I\'m here to win a war.'
,`Text0_1_loc9`='Hi! You\'re new. Did you lose your home too? You can sit with me if you want.'
,`Text0_1_loc9`='"You\'re definitely not from Thunderhammers. What brought you here? Now is not the best time to travel, that\'s for sure."'
...
,`Text0_1_loc9`='Exquisite weather here, wouldn\'t you say, $C?'
,`Text0_1_loc9`='Oh, it\'s been wonderful!$B$BThe commander is so confident, and that accent! I must admit, he\'s quite captivating.$B$BDo you know if he\'s married?'
,`Text0_1_loc9`='Word has it that some of the relics in these parts hold mystical power!$B$BHe seems to be fascinated with such things...'
,`Text0_1_loc9`='I\'m sorry, $C.$B$BI really don\'t know enough to discuss such things. And honestly, I would prefer to keep it that way.'

,`Text1_0_loc9`='Ve\'re vatchink you, $R...'

,`Text0_1_loc9`='Dragon\'s Mouth was established to give the Alliance their first real foothold here in the Badlands. Despite its position between Stormwind and Dun Morogh, the Badlands have traditionally been Horde territory.$B$BIf that\'s ever to change, we need to start asserting ourselves. Of course, the dragon attacks on New Kargath don\'t hurt our cause either.'



,`Text0_1_loc9`='I travelled all this way to speak with the famed "Seer of the Dragonmaw." I wanted to see inside Cho\'gall\'s dark heart before I tear it out.$B$BBut she\'s worthless to me. All riddles and rhyme. Maybe you can help.'

,`Text0_1_loc9`='For too long we have ignored the secrets of the Arcane.$B$BAre you here to learn, as well?'
,`Text0_1_loc9`='For too long we have ignored the secrets of the Arcane.$B$BSadly, they will remain a secret to you.'



,`Text0_1_loc9`='Sorry, $C. $B$BYour grasp of the arcane isn\'t strong enough to understand portal magic.'
,`Text0_1_loc9`='You too are a student of the arcane, yes?$B$BI can teach you about portal magic, if you wish to learn.'
,`Text0_1_loc9`='I\'m afraid I cannot help you, $R, but I am sure Khaelyn Steelwing can.'
,`Text0_1_loc9`='I\'m afraid I cannot assist you, $R, but I am certain Georgia can.'
,`Text1_0_loc9`='Schnottz is making a fortune because of us... where\'s ours?!'
,`Text3_0_loc9`='I was promised substantial wealth to come out here.$B$BWhat a joke!'
,`Text5_0_loc9`='Schnottz is making a fortune because of us... where\'s ours?!'
,`Text1_0_loc9`='After zhat ritual debacle, you owe me, $R.$B$BAnd I plan on collectink!'

,`Text0_1_loc9`='Through this portal, Tol Barad awaits.'
,`Text0_1_loc9`='I am well aware that the demonic presence in this forest can be considered the fault of my kind.$B$BI am also not the first Highborne to attempt to make amends for this, and I thank the Emerald Circle for being pragmatic enough to allow my help.'
,`Text0_1_loc9`='The Earthen Ring have set up portals to various regions of the world on a small lake islet northwest of Stormwind Keep.$B$BThere are representatives from the Baradin Wardens there as well, offering transport to Tol Barad.'

,`Text0_1_loc9`='If you\'re looking for an Arcane Reforger, there is a blood elf mage inside the Drag\'s enchanting shop, Godan\'s Runeworks.'
,`Text0_1_loc9`='<The Mullan Gryphon Rider stays still, eyes locked forward, not acknowledging your presence.>'
,`Text0_1_loc9`='Find the representatives of the Reliquary on the Royal Exchange. I have no doubt that among them there will be many archaeologists who will gladly help you.'
,`Text0_1_loc9`='Only the most important members of the Reliquary know where the Great Treasury is located.$B$B Rumor has it that it is somewhere in another world ...'

UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Duglas send you over to get roughed up?',`Text1_0_loc9`='Lookin\' to scrap?',`Text1_1_loc9`='Lookin\' to scrap?' WHERE `entry`=17212;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='You look like you want a piece of me...',`Text3_0_loc9`='Lookin\' for some punishment?',`Text3_1_loc9`='Lookin\' for some punishment?' WHERE `entry`=17212;

,`Text0_1_loc9`='May I suggest that you save us from the pirates, my dear $N?!'
,`Text0_1_loc9`='You\'ll want to find Adam Hossack. He\'s got an office in the southern Mage Quarter along the inner ring.$B$BIf he\'s not out exploring, he\'ll likely be there.'

,`Text0_1_loc9`='Be quick about it.'




,`Text0_1_loc9`='For Sylvanas!'

,`Text0_1_loc9`='Dedlow Wormwood\'s the corpse you want. He\'s usually around the south end of town.'
,`Text1_0_loc9`='Can I help ye with somethin\'?'

,`Text0_1_loc9`='This orc is severely injured.'
,`Text1_0_loc9`='I\'m working on a biographical piece for Commander Schnottz, among other things.$B$BYou\'ll have to excuse me.'

,`Text0_1_loc9`='I saw them loading a shipment of artifacts onto the boats the other day.$B$BIt was the most gold I\'ve ever seen in one place!'
...
UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=17245;



,`Text1_0_loc9`='Like father always said; it takes a shrewd mind, sharp instincts, and unfailing courage to become a successful investor.$B$BI must admit, I smelled this opportunity a mile away.'




,`Text0_1_loc9`='Don\'t - don\'t touch me...$B$BWhat\'s happening?!'
,`Text0_1_loc9`='No! Of course I\'m not alright!$B$BI-I\'ve never seen an actual corpse before...'
,`Text0_1_loc9`='He just came stumbing out of the barracks.$B$BI screamed for help, but the guards wouldn\'t even look at me!'
,`Text0_1_loc9`='Yes.$B$BThat sounds like a good idea.'

,`Text0_1_loc9`='Have you come for training, hunter?'




,`Text0_1_loc9`='I owe you a great deal for my freedom, $N.$B$BNow, let us see if we can free Magatha and put an end to the Twilight\'s Hammer in Thousand Needles.'
...
,`Text0_1_loc9`='The good Doktor Professor Ironpants may be found in the Hall of Explorers.'
,`Text0_1_loc9`='Ye\'ll find an Arcane Reforger in Gimble\'s shop, Thistlefuzz Arcanery, right by the Gryphon Master at The Great Forge.$B$BHe\'s one o\' them long-lost Highborne elves, but he\'ll do ye right.'
,`Text0_1_loc9`='There is a blood elf in the Valley of Strength\'s central fortress, part of a delegation from Silvermoon: Belloc. He is who you want.'
,`Text0_1_loc9`='The mages may be found in Cleft of Shadow. There are two entrances: One between the valleys of Strength and Wisdom, and the other in The Drag.'



,`Text1_0_loc9`='<The emissary sneers without looking at you.>$B$BGo about your business, $R.'

,`Text1_0_loc9`='I cannot be certain of what I saw.$B$BIt was over before I realized what was happening.'
...
,`Text0_1_loc9`='<The starlet stares at you blankly.>'
,`Text0_1_loc9`='"Archmage Pratt, a blacksmith sorcerer recently arrived from Dalaran, usually works with the local sorceress Lavinia Crowe. Both can be found in the Pharmacists area."'
,`Text0_1_loc9`='There is a scholar, Arunel, who can assist you. You will find him in the Temple of the Moon, often conversing with one of the returned Highborne.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Do I know you? No? Welcome to the Twilight\'s Hammer.',`Text1_0_loc9`='The end days are nigh!',`Text1_1_loc9`='The end days are nigh!' WHERE `entry`=17319;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='There\'s a little blood on your armor there. Are you okay?',`Text3_0_loc9`='New recruit? Have you reported to the commander yet?',`Text3_1_loc9`='New recruit? Have you reported to the commander yet?' WHERE `entry`=17319;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='Hey, you haven\'t seen Grom-Grom have you? Orc, about this tall. No?$B$BHmm. No one\'s seen him for a while. Probably went a.w.o.l.',`Text5_0_loc9`='Something big\'s brewing at the Withering to the east.$B$BWhatever it is, I hope that it\'ll be over soon and we get restationed somewhere nicer.',`Text5_1_loc9`='Something big\'s brewing at the Withering to the east.$B$BWhatever it is, I hope that it\'ll be over soon and we get restationed somewhere nicer.' WHERE `entry`=17319;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='Keep your eyes peeled. They say that freak that was attacking people earlier might still be around.',`Text7_0_loc9`='Isn\'t it weird that we\'re keeping Magatha Grimtotem captive here? Good thing all of her totems were destroyed.$B$BI even heard that she poisoned Cairne Bloodhoof. Wish she were on our side.',`Text7_1_loc9`='Isn\'t it weird that we\'re keeping Magatha Grimtotem captive here? Good thing all of her totems were destroyed.$B$BI even heard that she poisoned Cairne Bloodhoof. Wish she were on our side.' WHERE `entry`=17319;
,`Text0_1_loc9`='"The sorceress-smith Erim is located on a middle elevation, in the ""Wizards of the Dawn Wanderers."" She will help you."'

,`Text0_1_loc9`='Otoh Greyhide spends much of time in the Hall of Elders on the Elder Rise. Seek him out there, and he will help you.'
,`Text0_1_loc9`='You will find the Sunwalker\'s Lodge on Hunter\'s Rise.'
,`Text0_1_loc9`='soothsayers of the Summit of Elders will help you. Look for them in the Elders Hall.'
,`Text0_1_loc9`='The city\'s Arcane Reforger, Enchantress Fira, will be able to help you. She is most often found with Sedana and her enchanter\'s apprentices, off the Court of the Sun.'
,`Text0_1_loc9`='Perhaps you did not hear me. I said, get me free of these chains!'

,`Text0_1_loc9`='seek out Diya among the paintings surrounding the Throne of the Naaru. She will be happy to help you.'
,`Text0_1_loc9`='Dese caves be haunted, mon. Filled with the worst juju.$B$BIn days when de Twilight\'s Hammer be settin\' up atop de mountain, the unworthy were tossed into dese caverns. Into de Gullet. Food for de black drakes dat once nested here.$B$BDem people, dey never come out. Not even de spirits.'
,`Text0_1_loc9`='Greetings, $C!'
,`Text0_1_loc9`='Boduro the Seeker can often be found in the merchant\'s bazaar within the Lower City. I would look for him there.'
,`Text0_1_loc9`='Highborne Archmage Arangir Star\'s Song is a skilled blacksmith ... turn to him.$B$B You can often find him talking to enchanting learners at the Wizard\'s Chamber of Commerce in northwestern Dalaran.'
,`Text0_1_loc9`='The high elf mage and scholar Dariness is the city\'s most learned archaeologist... and the most sociable.$B$BShe can often be found in the Legerdemain Lounge, just north of the city\'s center, enjoying the atmosphere or discussing her wild adventures with the proprieters and patrons both.'

,`Text0_1_loc9`='"Bad Juju you do not care,$Gbaby: girl ;."'



,`Text0_1_loc9`='You lookin\' for trainin\'? No can do. I ain\'t your gal.'
,`Text0_1_loc9`='You lookin\' to train up, bruiser?'
,`Text0_1_loc9`='I don\'t be hearin\' de whispers no more, $N. What happened in de cave?'
,`Text0_1_loc9`='Do you want to see the utter destruction of what\'s left of Thousand Needles?$B$BNo?$B$BThen do exactly as I command.'
,`Text0_1_loc9`='This is where we gather the surivors to prepare them for decontamination. From there, it\'s just a short trip to the surface!'





,`Text1_0_loc9`='You foolishly stumble about here, $R, oblivious to what forces surround you.'
...
,`Text0_1_loc9`='We\'ve long held out hope of redeeming the Earthwarden and his children. At some point, we must have the wisdom to realize that no amount of redemption can atone for the destruction these dragons are unleashing upon the world.$B$BAt some point, we are forced to intervene.'
,`Text0_1_loc9`='Oh... I wish I\'d never come to this place!'



,`Text0_1_loc9`='This is all too much to bear.$B$BI wish I had the nerve to... <sob>.'
...
,`Text0_1_loc9`='Thundermar is the last holdout of the Wildhammer. My brother\'s trying to keep up the fight while our little town fills up with refugees.'
...
,`Text0_1_loc9`='Now that we have captured this wretched isle, we need to do some work to get it into shape. Can you help us out $N?'
,`Text0_1_loc9`='I am not a fan of that d-block place everyone keeps talking about it. We do have some tasks that must be completed before we can use it though.'
,`Text0_1_loc9`='I assume you have heard of the hole by now, $R. If not, you are going to know a whole lot about it soon.'
,`Text0_1_loc9`='Welcome to Tol Barad, $C. Time\'s a wastin\' so let\'s get to work.'
...
,`Text0_1_loc9`='It looks like the cultists had their eye on the druids!$B$BYou can see Wildheart Point through the swirling portal. Stepping through it will take you on a one-way trip back to the camp.$B$BOnce your business here is finished, this would be a good way to make a quick exit.'





,`Text0_1_loc9`='Alsudar the Bastion and the other warrior trainers may be found overlooking Farstriders\' Square, from near the foundry.'
,`Text0_1_loc9`='Lot\'s to be done around here, $R. Are you ready to help?'
,`Text0_1_loc9`='Welcome to baradin base camp. I know it does not look like much now, but with a little hard work we can whip this place into shape.'
,`Text0_1_loc9`='Seems like we never run out of things to do around here. New orders arrive every day at 3am, it\'s really strange.'
,`Text0_1_loc9`='The horde have been relentless out here. Feels like we are fighting two battles at one time.'



,`Text1_0_loc9`='Soon, our sideshow will be the talk of Azeroth!'


,`Text0_1_loc9`='If we don\'t increase production as much as possible, the Horde might lose this war. If the Horde loses the war, we\'re out on our butts at best and dead at worst.$B$BI hate to break it to you, but the pretty things you might have heard at Whisperwind Grove won\'t save us... but hard work might.'




,`Text0_1_loc9`='A few of us here have lived in this land since the Scythe of Elune first passed through it. Most suffered through the fall of Gilneas.$B$BWe have settled in this forest to learn the ways of nature and uphold its balance. In this cursed land, our cursed people have found a new way of life.'





,`Text0_1_loc9`='I wish I could make you a deal, partner - I really do - but you\'ll need to be exalted with the Bilgewater Cartel, first.'
,`Text0_1_loc9`='Yo! I\'m Kall Worthaton, Bilgewater Trikes.$B$BGo ahead, look over the lot. Pick out the trike that you REALLY want!$B$BA trike that\'s a blast to ride... a trike that\'s dangerous and death-defying... a trike you can be PROUD of!$B$BYou let me know when you see it, and we\'ll make a deal.'

,`Text0_1_loc9`='Dey be on top of de tall building in de southeast end of de valley.'
,`Text0_1_loc9`='You be here ta learn fishin\', mon? Or maybe ta buy some tings for it?'
...
,`Text0_1_loc9`='"Frankly, I did not wait for guests. You$Giskal: searched; me or just can\'t find a way out?"'


,`Text0_1_loc9`='Need a ride, $G sugar: scumbag;?  Hop on. We\'re headed down to Bogpaddle, and it\'s a one way trip.'




,`Text0_1_loc9`='Hey. How ya doing, boss? Hobart and I are working on some things that will ensure that you have phenomenal backup products for when the kaja\'mite runs out.$B$BThere\'s only so much of it left down there in the mines, and when it\'s gone, all of the Kaja\'Cola is going to go with it, I\'m afraid.'


,`Text0_1_loc9`='It looks like this is the end, but I\'ll be brave if you will, $N.'

UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Yeah? Whadya want?',`Text1_0_loc9`='I\'m not talking to any rabble!',`Text1_1_loc9`='I don\'t talk to no $G scrub : trash;!' WHERE `entry`=17549;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='You\'re not quite in my league, honey.',`Text3_0_loc9`='"I didn\'t communicate with you at school, and now I\'m not going to."',`Text3_1_loc9`='I didn\'t talk to you back in school and I\'m sure not going to start now.' WHERE `entry`=17549;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='That\'s an interesting... "outfit" you\'re wearing.',`Text5_0_loc9`='"Yes. Bring me another drink, yes quick."',`Text5_1_loc9`='Yes. I\'d love a refill. Fetch one and be quick about it.' WHERE `entry`=17549;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='This is the Trade Prince\'s party, sweetie. Invite only!',`Text7_0_loc9`='"$N, right? Here\'s a tip for you: don\'t catch the eye of the merchant prince. He knows that you want to get his position.$B$B Everyone knows that."',`Text7_1_loc9`='$N, right? Word of advice: don\'t let the Trade Prince catch you around here. He knows you\'re after his job.$B$BEveryone knows.' WHERE `entry`=17549;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='A mook?! I don\'t speak to brutes. How dare you!',`Text1_0_loc9`='so what are you now called? Monsters Hobgoblins?$B$B I can\'t remember. Get out.',`Text1_1_loc9`='What are we calling you things these days? Brutes? Hobgoblins?$B$BI can\'t keep it straight. Get out of here.' WHERE `entry`=17550;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='You\'re big and strong. But you need a bath. Go jump in the pool.',`Text3_0_loc9`='"Oh no! No, we didn\'t talk!"',`Text3_1_loc9`='Oh no you did not just talk to me!' WHERE `entry`=17550;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='What smells around here? Oh, that\'d be you.$B$BBeat it!',`Text5_0_loc9`='"What is your name?$B$BIt\'s good that you monsters can\'t talk. Otherwise, I would have to complain to the trading prince that you annoy me.$B$BA now get out!"',`Text5_1_loc9`='What\'s your name?$B$BI guess it\'s a good thing you brutes can\'t talk. Otherwise, I\'d have to tell the Trade Prince how you annoyed me.$B$BNow scram!' WHERE `entry`=17550;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='Touch me one more time and I\'ll make sure that they send you to the Undermine!',`Text7_0_loc9`='"Oh, you are just a disgusting monster! Why are different freaks always trying to take me off ?!"',`Text7_1_loc9`='Oh, you\'re just disgusting! Why is it always the ugly ones that try to pickup on me?!' WHERE `entry`=17550;
,`Text1_0_loc9`='<To your astonishment, the Raptor hatchling is able to communicate with you.>$B$BI hunger... therefore, I am.'
,`Text3_0_loc9`='<To your astonishment, the Raptor hatchling is able to communicate with you.>$B$BThey call you $N. Is this your unique signifier, or is it an honorary title?'
,`Text5_0_loc9`='<To your astonishment, the Raptor hatchling is able to communicate with you.>$B$BIs it true that you cook your meat? Curious.'
,`Text7_0_loc9`='<To your astonishment, the Raptor hatchling is able to communicate with you.>$B$BThe ends of your fingers are dull and round. Is this why you carry around other implements for use in combat?$B$BHow interesting.'

,`Text0_1_loc9`='Don\'t worry about Hobart, boss. He\'s just having a bit of a breakdown right now.$B$BThe Cataclysm couldn\'t have come at a worse time for him. He was so close to being done with the Micro Mechachicken.'



,`Text0_1_loc9`='Get away from me, you abomination!'
,`Text0_1_loc9`='The undead are a taint upon Azeroth!  Every one of you creatures deserves to be destroyed!'





,`Text0_1_loc9`='It\'s your big coming out party. We\'ll make you a Trade $G Prince : Princess; yet, $N!$B$BGet out there and strut your stuff!'
,`Text0_1_loc9`='Pirates?! Boss, you have to deal with this! They\'re ruining the party!'
,`Text0_1_loc9`='This isn\'t looking good, boss.'
,`Text0_1_loc9`='Boss, we gotta get you a bazillion macaroons by any means possible!'
,`Text0_1_loc9`='We gotta finish up here and get you to the dock before the Trade Prince leaves us all behind!'



,`Text0_1_loc9`='I understand that Alexstrasza has pronounced judgement on Deathwing. Perhaps this whole ordeal will end, right here?'


,`Text0_1_loc9`='Congratulations, adventurer.'
,`Text0_1_loc9`='You\'ve managed to walk right into my trap!'
...
,`Text0_1_loc9`='Great work getting this place going, $N!'
,`Text0_1_loc9`='You gotta do something about these pygmies, $N!'

,`Text0_1_loc9`='How much did you charge to deploy this place?'
,`Text0_1_loc9`='Zombies, goblin or not, are an abomination in the eyes of the Light. Besides, there\'s no profit in them.$B$BNot yet anyway.'
,`Text0_1_loc9`='Deploying an urban setting in the middle of the wild. I love it!'
,`Text0_1_loc9`='"Can I sneak up on zombies? Don\'t they learn your brains if you get close to them?$B$B If so, then half the locals have absolutely nothing to fear.$B$B Do you want to learn something,$N?"'
,`Text0_1_loc9`='Can you sneak up on zombies? Don\'t they smell your brains when you get close?$B$BHalf the people around here have nothing to worry about then.'

,`Text0_1_loc9`='I went too far to surrender to a handful of inanimate bandits.'
...
,`Text0_1_loc9`='That statue\'s provin\' ta be quite the pain. I thought we could lift it up an\' outta the water with a crane an\' some well timed explosives. But Wick thought we\'d be safer an\' do less damage by rolling it up this ramp.$B$BNow look at it... We\'ve got it angled all wrong. An\' once we get it to the top, then what?$B$BI\'ve gotta bad feeling we\'re gonna to be here a long time. A real long time...'
,`Text0_1_loc9`='I get a lot of mail, $N. Most of it is junk, but some of them might be helpful to a helpful $C like you. Here\'s a couple letters sent to Everlook, looking for help in the far corners of the world.$B$BIt\'s almost as if you have a choice for where you go next!  Now, let\'s see...'



,`Text0_1_loc9`='This was one of the royal cities of the elves in the days when Azshara was queen. In this city lie the keys to lore long lost and artifacts of unimaginable historical value.'
,`Text0_1_loc9`='The admiral and his forces pushed forward to take one of the bases you scouted for him earlier. You should go and meet them.'
,`Text0_1_loc9`='The captain  and his forces pushed forward to take one of the bases you scouted for him earlier. You should go and meet them.'
,`Text0_1_loc9`='My apologies, $C, but the arcane secrets of the Highborne will forever remain secrets to you.'

,`Text0_1_loc9`='The magic of today pales in comparison to that of millennia past. Still, we Highborne know much of the arcane. Are you ready to learn?'
,`Text0_1_loc9`='Halbin Frosthammer, from the Wildhammer clan, can be found in Thunderbrew Distillery. He can help teach ya the ways of the shaman.'
,`Text0_1_loc9`='Greetings, $N.'
,`Text0_1_loc9`='Look for The Wyvern\'s Tail, just outside the Hall of the Brave.'
,`Text0_1_loc9`='It\'s across the bridge from the gate to The Drag. Listen for the sound of shouting goblins.'
,`Text0_1_loc9`='Lotan is where weapons and armor are. A warrior is always next to his sword.'
,`Text0_1_loc9`='The Valley of Honor\'s bank is just before the gate to The Drag.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='To reach the Rut\'theran Ferry, you will need to travel to Darnassus and take the portal to Rut\'theran Village at the base of Teldrassil.',`Text1_0_loc9`='If you wish to use a hippogryph, speak with Fidelio.',`Text1_1_loc9`='If you wish to use a hippogryph, speak with Fidelio.' WHERE `entry`=17759;

,`Text0_1_loc9`='There is a Highborne archmage visiting the city\'s Enchanting trainer. You can have your items reforged there.'

,`Text0_1_loc9`='Which one?'


,`Text0_1_loc9`='Choose a destination.'
,`Text0_1_loc9`='I will mark the location upon your map.'
,`Text0_1_loc9`='When we returned from Deepholm, we found that the Twilight\'s Hammer had established a base here and taken control of the elemental portals.$B$BPlease, $N, you must stop them before Cho\'gall can complete whatever it is that he\'s up to inside the Bastion of Twilight!'
...
,`Text0_1_loc9`='After all we\'ve been through, we Gilneans have not given up hope.'

,`Text0_1_loc9`='This teleportation device appears to have been used recently to teleport various goods deeper into the mine.'
,`Text0_1_loc9`='This isn\'t over, $N. Not by a long shot.'
,`Text0_1_loc9`='Ahh... so it is, so it is. Carry on then. Carry on t\'yer death.'
,`Text0_1_loc9`='Welcome to the Wickerman Festival, $C!$B$BOn the observance of Hallow\'s End, we burn a Wickerman to represent a cleansing of the self. As the woods sigh and shed their leaves, we too must undergo a catharsis. Fears, sorrows, regrets: by throwing a branch into the blaze, you can relieve yourself of any burden you would not bear into winter.$B$BPlease, grab a branch from the bonfire and join the celebration!'


,`Text1_0_loc9`='The kid tries to hit the tiny fly with his paw and pays attention to you only after his toy flies away.'
,`Text3_0_loc9`='The kid bites and hits with the paw of an invisible adversary: ​​he is impatient to evaluate his hunting skills.'

,`Text0_1_loc9`='Though many flames are fought over, extinguished and re-lit, all are welcome to show honor to the flame, $C.$B$BHere among the Earthen Ring, we simply honor the flame, rather than engage in other frivolities.$B$BHere, we will honor the flame as tradition dictates. Will you join with us in honoring the flame, $N?'


,`Text0_1_loc9`='Hallow\'s End is upon us, $C. I hope you are enjoying the festivities.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='"Hello! Great day, right?"',`Text1_0_loc9`='Have you seen what prices are going up here? Horror!',`Text1_1_loc9`='Have you seen what prices are going up here? Horror!' WHERE `entry`=17850;
,`Text2_1_loc9`='"Will you bring me something to drink? I myself would go, but sunbathe."'
,`Text0_1_loc9`='Welcome to the Menders\' Stead, $C.'
,`Text1_0_loc9`='Yarr!'


,`Text0_1_loc9`='While I miss Gilneas greatly, there\'s ancient ruins to explore!'

,`Text0_1_loc9`='Our brothers at Baradin Hold on Tol Barad are very busy and not always available when you need them. I have been stationed here around the clock to help you with tasks they might have given you.'





UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='How can Bwemba aid ya?',`Text1_0_loc9`='Bwemba will keep an eye on you.',`Text1_1_loc9`='Bwemba be watchin\' you, young one.' WHERE `entry`=17890;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='My spirit be watchin\' over ya, $N.',`Text3_0_loc9`='It is not very easy to move in the form of a spirit.',`Text3_1_loc9`='Spirit walkin\' be taxin\' work.' WHERE `entry`=17890;
,`Text0_1_loc9`='You seek power, yes? But will you walk the cursed path I do for it?'
,`Text0_1_loc9`='My path is a dark and cursed one, $C. You do not wish to walk with me.'
,`Text0_1_loc9`='"The registrar of guilds, as well as the seller of guild items and tabards in Shattrath can be found in the center of the Terrace of the Light, in the heart of the city."'
,`Text0_1_loc9`='"Class skills teachers can be found on the lower levels in the center of the Terrace of the Light.$B$B Someone can always help you regardless of whether you belong to the Aldor, the Seers or some other faction."'

,`Text0_1_loc9`='"Shaman? .. Some troll sorceress recently arrived in the city to visit Haren, who lives in the north of the Elders\' Path. Maybe she will help you."'

,`Text0_1_loc9`='What?! My brother was kidnapped by the Burning Blade ?!'
,`Text0_1_loc9`='All the supplies flowing north to Ashenvale stop here to rest and re-fuel. It\'s important to keep our operations running smoothly.'
,`Text0_1_loc9`='Welcome, my $G brother : sister;. If you are here to train, then I would be delighted to train you.'
,`Text0_1_loc9`='If you seek training in the Old Ways, I cannot help you.'
,`Text0_1_loc9`='There\'s a worgen druid by the name of Dareth just outside the city gates; he might be able to help you.$B$BBig beast of a fellow, covered in white leather and furs. You can\'t miss him.'


,`Text0_1_loc9`='Ahh! There you are, $N.$B$BI must speak with you at once.'



,`Text0_1_loc9`='You mustn\'t tarry, $N.$B$BAnachronos awaits!'
,`Text1_0_loc9`='This artifact appears to be intact, though it is so thoroughly coated in dirt and mud that it is difficult to tell for sure. There does not seem to be anything inherently magical about it.'
,`Text3_0_loc9`='Several leaves and branches cling to this object, indicating that it may have been used as part of a nest for some creature. There is otherwise nothing of note.'
,`Text5_0_loc9`='Mysterious runes adorn this artifact, though they appear to be unpowered at this time.'
,`Text7_0_loc9`='Several spots of dried blood can be seen on this object, likely a result of the struggle to obtain the artifact by the trolls. The object is quite plain, however, and may not have been worth the struggle.'


,`Text0_1_loc9`='Ye want Deepmountain Mining and Jewelcrafting, over on the northern side of The Great Forge.'
,`Text0_1_loc9`='A blacksmith and his assistant can be found working in the Warrior\'s Terrace, near the armor and weapon vendors there.'
,`Text0_1_loc9`='"Ah, a pair of Silver Dew! You will find them on the Craftsman Terrace, next to the enchanting goods. They just recently opened a store."'

,`Text0_1_loc9`='$N, it is good to see you. Have you come to help push the front for us?'
,`Text0_1_loc9`='The elemental forces are relentless. I fear we\'ll not be able to hold this breach forever. Not without more help.'



,`Text1_0_loc9`='We stand in the heart of Beth\'tilac\'s breeding ground. Beyond those pillars to the north, her brood awaits. They will defend her young relentlessly.'


,`Text0_1_loc9`='Greetings, $C. The Fire Lord has twisted our former brothers and sisters into avatars of molten fury. Even now, the Druids of the Flame carry out his insane plan to destroy the World Tree. We will not let that happen.'




,`Text0_1_loc9`='Are you here to aid da Darkspear, $C?'
,`Text0_1_loc9`='I be an emissary from da Darkspear trolls. Da threat we face, also be a threat to da Alliance. You willin\' to help out da Darkspear, $R?'


,`Text0_1_loc9`='This place be reekin\' of death and sacrifice.$B$BBest you leave before you become da next prisoner.'
,`Text0_1_loc9`='It be good to be outta dat cage. Norkani will have her revenge...'
,`Text0_1_loc9`='Where am I? You be here to help?'
,`Text0_1_loc9`='These trolls have made a grave mistake, $C.'
,`Text0_1_loc9`='Ya have my gratitude for gettin\' me outta dat cage. My wits are finally returnin\' an\' I\'ll be able to tell Vol\'jin what I learned.'

,`Text1_0_loc9`='I\'m here to represent Booty Bay\'s interest in this expedition.$B$BIf things go bad, Booty Bay is in trouble.$B$BWe are still recovering from the events of the cataclysm.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='In the nature of all things is the will to survive.',`Text1_0_loc9`='"What is war, if not an attempt to save life? As a seed tries to break through the soil to germinate, so we fight in the name of our existence."',`Text1_1_loc9`='What is war, but the preservation of life? Just as the seed struggles to push out of the soil, so do we fight for our own existence.' WHERE `entry`=18025;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Hello there! You\'re really growing on me.',`Text3_0_loc9`='Will we win this war? Time will tell.',`Text3_1_loc9`='Will we win this war? Only thyme will tell.' WHERE `entry`=18025;
UPDATE `locales_npc_text` SET ,`Text4_1_loc9`='It\'s sweltering down here. Did someone tell them to turnip the heat?',`Text5_0_loc9`='I like you. We will work together.',`Text5_1_loc9`='I like you! Weed make anise pear.' WHERE `entry`=18025;
UPDATE `locales_npc_text` SET ,`Text6_1_loc9`='Some people say I\'m corny, but I think I\'m rather sage.',`Text7_0_loc9`='"Ah, it\'s you again! Do you think we can collect the reinforcements we need?"',`Text7_1_loc9`='Oh, it\'s you again! Do you think we\'ll be able to mustard up the forces we need?' WHERE `entry`=18025;


,`Text0_1_loc9`='That Malfurion... fitting of him to send his $R underling to speak with me.$B$BHe has proven himself a coward, as always.'
,`Text0_1_loc9`='Never you mind, $R. The details of my past were burned away when I joined the Druids of the Flame. They are of no concern to you.$B$BBesides, I am here to discuss the future of this realm. And I do not plan to discuss it with you.$B$BNow answer me... where is Malfurion!?'
,`Text0_1_loc9`='Very well. Malfurion shall press into the Firelands, and we will deal with him there. His judgment can wait for a few more brief days.$B$B<Leyara\'s eyes light up.>$B$BThe tauren arch druid, however, will not be so lucky.'

,`Text1_0_loc9`='I can barely understand what these trolls are trying to say.'


UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Glad you could make it, $N.',`Text1_0_loc9`='"Welcome to Molten Stream,$N."',`Text1_1_loc9`='Welcome to the Molten Flow, $N.' WHERE `entry`=18041;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='The flamewakers up ahead mean business. Be careful in there.',`Text3_0_loc9`='"I\'m afraid some druid,$N, could be lost in the cave. Watch attentively."',`Text3_1_loc9`='I fear there may be a lost druid in the back of the cave, $N. Be on the lookout.' WHERE `entry`=18041;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Glad you could make it, $N.',`Text1_0_loc9`='"Welcome to Molten Stream,$N."',`Text1_1_loc9`='Welcome to the Molten Flow, $N.' WHERE `entry`=18042;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='The flamewakers up ahead mean business. Be careful in there.',`Text3_0_loc9`='"There are a lot of warm streams ahead,$N. When you get stuck, use them!"',`Text3_1_loc9`='There are plenty of thermal vents up ahead, $N. Feel free to use them if you get into a jam.' WHERE `entry`=18042;
,`Text0_1_loc9`='Your deeds shall live on forever in the memories of every blue dragon, $N.'


,`Text0_1_loc9`='I can teach the art of cooking.$B$BAre you looking to learn?'
,`Text0_1_loc9`='My, it sure is hot down here. I didn\'t even need to bring my own forge.'
,`Text0_1_loc9`='That island over there is full of Obsidium creatures! I\'d go over there myself, but I can\'t get across the bridge.'


,`Text0_1_loc9`='I consider it a great honor to assist the Lady Proudmoore in her research. She\'s the most powerful human mage upon Azeroth, you know!$B$BNow, was there something I might help you with?'

,`Text0_1_loc9`='You mean to say there is a warlock? Here, in goodly Theramore?!$B$BOh, my. Someone must inform Lady Proudmoore immediately!$B$B...heh.'



,`Text0_1_loc9`='"He is obsessed with gems, but I love him. Let\'s just say I\'m his favorite gem!$B$BWell, what brings you to me? Archeology, right?"'



,`Text0_1_loc9`='Look for Jensen Farran near the archery range.'
,`Text0_1_loc9`='You\'ll find Horace Alder pacing about above the ground level of Lady Proudmoore\'s tower.'
,`Text0_1_loc9`='Look for Brother Karman overseeing training at the combat dummies outside the barracks.'

,`Text0_1_loc9`='I\'m not certain. Try asking Calia Hastings, by the docks. I\'m told she has connections to SI:7.'


,`Text0_1_loc9`='Report to Captain Evencane on the second level of the barracks. He can see to your training.'
,`Text0_1_loc9`='Alchemist Narett and Brant Jasperbloom teach Alchemy and Herbalism out of a small shop here; they\'ll be able to help you.'

,`Text0_1_loc9`='Ask for Marie Holdston at the smithy.'
,`Text0_1_loc9`='Craig Nollward works the inn\'s kitchen. He\'ll be able to help you.'
,`Text0_1_loc9`='Lissah Spellwick, at the top of mage tower, is the mistress of Lady Jaina\'s enchanters.'
,`Text0_1_loc9`='Look for Caz Twosprocket at the smithy.'
,`Text0_1_loc9`='Doctor Gustaf VanHowzen works on the ground level of the barracks.'
,`Text0_1_loc9`='Michael Crowe, down by the docks, can teach you anything you need to know about catching and gutting fish.'
,`Text0_1_loc9`='Look for Theoden Manners at the top of Lady Proudmoore\'s tower.'

,`Text0_1_loc9`='Seek out the Tanwell brothers in Theramore\'s inn. One of them will be able to help you.'

,`Text0_1_loc9`='You\'ll want to find Sansha MacVince, just outside Theramore\'s stables.'
,`Text0_1_loc9`='Timothy Worthington works out of the second floor of one of Theramore\'s larger buildings. He\'ll do you right.'


UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Do not worry. I will keep the Crimson Lasher safe with me. Until we learn more about its behavior, I\'m afraid it must stay here in the Firelands.',`Text1_0_loc9`='What an unusual look! How many opportunities he has! I need to devote myself to the study of local flora and fauna.',`Text1_1_loc9`='Such a unique specimen! So many possibilities! I must devote myself harder to the study of the local flora and fauna.' WHERE `entry`=18124;
,`Text2_1_loc9`='While I am buried in research, it will be up to you to teach the Lasher the ways of the world.'


,`Text0_1_loc9`='<The Shadow Warden looks at you silently.>'

,`Text0_1_loc9`='We cannot rest yet, my child. Hyjal still stands, but if we falter on the Fire Lord\'s doorstep, all may still be lost. Let the strength of the ancients be with us.'
,`Text0_1_loc9`='Our Storm Crows struggle to fly in this high density air, but the fire hawks on that ridge seem to soar with ease.$B$BThey are as wild as any of the creatures in the Plane of Fire, yet there is beauty in their form.'



UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Any questions you have about the Wardens can be answered on the field of battle.',`Text1_0_loc9`='"Who are the guards? We are a well-aimed blow, always reaching the goal."',`Text1_1_loc9`='What are the Wardens? We are the precision slice of a killing blow.' WHERE `entry`=18143;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='What are the Wardens? We are the hum of a spinning blade in the moment before death.',`Text3_0_loc9`='Who are the guards? This is the ominous silence of darkness.',`Text3_1_loc9`='What are the Wardens? We are the silence in the shadows.' WHERE `entry`=18143;



,`Text0_1_loc9`='Look with your eyes. What do you see? What do you feel?'

,`Text0_1_loc9`='Welcome, $N. Have you come to join the invasion of the Firelands?'
,`Text0_1_loc9`='While we prepare to invade the Firelands, the Firelord sends his minions to repel our attack. Our position here cannot fall. We are all that stands between them and the World Tree.'
,`Text0_1_loc9`='We do not yet have the strength to push forward into the Firelands. First, we must rebuild our forces and supplies. Will you lend yourself to our efforts?'
,`Text0_1_loc9`='What happens now will affect us all. Everyone\'s aid is needed. We must work together to fight against the invasion.'
,`Text0_1_loc9`='Are there any teeny tiny animals in need of my aid?$B$B<Mylune\'s eyes glisten at the thought.>$B$BI need to hug a bunny right now!'
,`Text0_1_loc9`='How are the preparations going?'


,`Text0_1_loc9`='Hello, $N. Are you helping with the invasion? A skilled $C such as yourself will be a valuable addition to our force.'

,`Text0_1_loc9`='Greetings, mage. Shall I provide you with further insight into the world of magic?'
,`Text0_1_loc9`='I have no time for a sermon now, $C. Seek your knowledge elsewhere.'
,`Text0_1_loc9`='The Light gives us the strength and magic to triumph.'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='In the nature of all things is the will to survive.',`Text1_0_loc9`='"What is war, if not an attempt to save life? As a seed tries to break through the soil to germinate, so we fight in the name of our existence."',`Text1_1_loc9`='What is war, but the preservation of life? Just as the seed struggles to push out of the soil, so do we fight for our own existence.' WHERE `entry`=18165;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='Hello there! Plants are my speciality. Do you have an inquiry about the local flora?',`Text3_0_loc9`='There is nothing more inspiring than flowering plants!',`Text3_1_loc9`='There\'s nothing more inspiring than a flower in bloom!' WHERE `entry`=18165;
,`Text0_1_loc9`='I apologize, $C. I mistook you for someone with a spine. Begone; our secrets are not for untrained ears.'

,`Text0_1_loc9`='We have little to discuss, $C. Perhaps you should seek other, more like-minded individuals.'
,`Text0_1_loc9`='Do you prefer guns or bows?'
,`Text0_1_loc9`='I train only warriors, $C. You\'ll have to look elsewhere.'
,`Text0_1_loc9`='Ours is a path for those with an iron will and unfaltering resolve. You seem to possess none of these traits, $C.'
,`Text0_1_loc9`='$N, how may I further your training?'
,`Text0_1_loc9`='If you seek training, I cannot help you.'
,`Text0_1_loc9`='It appears you took a wrong turn, $C.'
,`Text0_1_loc9`='My Go\'el... consumed by the sea. Tormented by his own desires!'
,`Text0_1_loc9`='The cycle begins again! Go\'el has become living stone! We must pursue him within the caverns of Deepholm.$B$BSeeing as how the Earthen Ring just saved her kingdom, Therazane should be more than willing to help us in saving him. If not, the Stonemother will answer to me!'
,`Text0_1_loc9`='Can you feel the magic in the air, $C?'
,`Text0_1_loc9`='You come to join the fight, $C?'
,`Text0_1_loc9`='$N, I am not surprised to see you here. I always thought you were my brightest pupil. I am honored to fight alongside you, my friend.'
,`Text0_1_loc9`='The children love this holiday. Some children have gone out trick-or-treating, some have stayed behind, and some, like these, have decided to try to run a small business.$B$BTheir goal is to amass as much candy as possible, and they felt the best way was to offer treats for the hard work of others. I laughed when I first heard of their plan, $C. But now that I see how many adventurers are giving them candy for their wares, I am worried.$B$BThat is a lot of sugar. I don\'t think the children will ever be able to fall asleep again.'
,`Text0_1_loc9`='No matter how far it takes me - I refuse to give up on him.'
,`Text0_1_loc9`='I can only teleport us once. Make sure you are ready. Go\'el waits for us at the bottom of the ocean...'

,`Text0_1_loc9`='The sooner we can get away from the Stonemother, the better. I do not trust her.'

,`Text0_1_loc9`='How can he just STAND there, while we fight off the attackers at his feet?'
,`Text0_1_loc9`='Brace yourself. The Firelands are a dangerous place... even for a formidable $R such as yourself.$B$BLet me know when you are ready.'
,`Text0_1_loc9`='Of course, I will share my knowledge with you.'


,`Text0_1_loc9`='We will need the help of ALL the elements to save Thrall from this place. The lieutenants of Ragnaros will not be nearly as compromising as Cyclonas, Hydrius, or even Therazane.'
,`Text0_1_loc9`='I can\'t believe that it\'s... over...$B$BGo\'el is free, thanks in no small part to you, $N.'
,`Text0_1_loc9`='You are right. I will see you in Mount Hyjal, friend.'


,`Text0_1_loc9`='"On the Tier of Seers there is a Seer Library dedicated to various professions.$B$B What you need, you will find there."'
...
,`Text0_1_loc9`='I am gathering my strength before I return to the battle. You would be wise to do the same.'
,`Text0_1_loc9`='The spiders here are as big as... me! Do you know how to get rid of a spider infestation?$B$BYeah, that\'s right. Dynamite. Lots and lots of dynamite.'
,`Text0_1_loc9`='Legends of the great white stag have persisted in my culture for as long as we tauren can remember. Malorne likely stood guard over the primal forests at the very dawn of the world. He was an ancient spirit, the very embodiment of nature\'s power and purity!$B$BLong ago, the greatest tauren hunters would track the white stag when the moon was full. To catch even a glimpse of his shimmering hide through the trees was said to bring great fortune to the tribe for a generation.$B$BDid you know that Malorne was the consort of the moon goddess?'
,`Text0_1_loc9`='Yes, Malorne was consort to the moon goddess herself, the one the night elves call "Elune." From their union was born Cenarius, the patron god of all druids and one of the most powerful creatures ever to walk upon Azeroth.$B$BBut listen to me, I ramble on.$B$BMalorne is an incredible force of nature, but he only interacts with the mortal races in times of dire trouble. Have you heard about his deeds during the War of the Ancients?'



,`Text0_1_loc9`='Back behind me, where you first came in, there is a large thermal vent, blowing hot air up and out of this place. Stand on top of the vent, and then... jump! The momentum from your leap should be enough to propel you up to the top.$B$BOh, one more thing - based on some reports I\'m hearing from fellow druids, make sure you watch your head on the way out.'
,`Text0_1_loc9`='Of course. By the way: you\'ll find several smaller vents which behave the same way, deeper in the cavern. With time, you may learn to use them to travel more efficiently within the cavern - or simply as a way to torment those gutless flamewakers.'
,`Text0_1_loc9`='Well, my master Morthis is really the expert, but I can share with you what I know.$B$BThey are not birds. Certainly, they fly, their wings have the appearance of feathers, and we even call them hawks, but that is where the comparisons to birds stop. In fact, it would appear that they have more in common with dragons: an affinity for fire, a solitary nature, and - based on what we\'ve seen - some indications of intelligence.'
,`Text0_1_loc9`='Isn\'t it? However, they do differ from dragons when it comes to their lifespan. Whereas the dragons of our world can live for millenia on end, these fire hawks live brief lives, passing quickly from egg to adulthood to death.$B$BThough my master warns against making emotional connections to our studies, sometimes I can\'t help but feel sorry for them. They burn so brightly in life... but in death, they\'re quickly replaced and forgotten.'


,`Text0_1_loc9`='Not much, I\'m afraid. I\'m no druid, I\'m here to lead troops. Seems odd to me that Malfurion tried to plant a tree in the middle of a warzone, but... like I said, I\'m no druid.$B$BHowever, I can tell you this. NOTHING makes those fire elementals angrier than the idea of a big, leafy tree growing right in the middle of their homeland. If nothing else, when this tree grows to its full size, it will be a beacon of hope for our forces... and a thorn in the side of our enemy.'
,`Text0_1_loc9`='Ten thousand years ago, when the demons of the Burning Legion invaded Azeroth, the ancients fought side-by-side with the mortal races. Many of the ancients met their end by the Legion\'s hand. Cenarius would\'ve been killed as well, were it not for the actions of his father, Malorne.$B$BThe mighty stag leapt into battle, his hooves crashing down on demon skulls and his antlers piercing their fiery flesh.$B$BThen Archimonde the Defiler took to the field of battle. After a fierce fight, he seized Malorne by his antlers and... and snapped the ancient\'s neck.$B$BBut as long as there\'s life in the world, can a force of nature like Malorne ever truly die?'
,`Text0_1_loc9`='Go\'el - the one you call Thrall - his spirit has been scattered across the elemental planes.$B$BThe Twilight\'s Hammer thinks to shake our will... but we shall not weaken. We will not forsake Go\'el.$B$BHe has risked everything to save this world, and we\'ll do no less for him!'
,`Text0_1_loc9`='Let me know when you are ready to travel to Uldum. We will ask Cyclonas what he knows.'
,`Text0_1_loc9`='Fandral Staghelm has returned as a ... "Druid of the Flame?"$B$BI fear one of my own may be implicated in this betrayal!'


,`Text0_1_loc9`='The world-shaman - shattered by the hand of Fandral Staghelm?$B$BGreater powers are at work here. Ragnaros has pushed his strength farther into this realm than I would have imagined.$B$BThe Firelord must be stopped!'



,`Text0_1_loc9`='The Darkmoon Faire is now open!$B$BFor a small fee, I can teleport you to the fairground staging area.$B$BWould you like to go?'

,`Text0_1_loc9`='You need a troll. Jabul. He will help.'
,`Text0_1_loc9`='Our ethereal technomancy has the ability to modify an item\'s arcane essence in ways previously unimaginable. We can also house items in a pocket dimension... for a small fee. See my associates for details.$B$BUnless you have something for me to examine?'
,`Text0_1_loc9`='Hey, hey!$B$BI\'m sure you can land a ring on a slow-moving turtle.$B$BWhat do you say?'
,`Text0_1_loc9`='You give me a game token, and I\'ll give you ten rings. $B$BThrow the rings onto the Dubenko the Darkmoon Turtle over there... see the pole he\'s carrying on his shell?$B$BIf you don\'t land enough rings to win in one go, try again! Your points carry over into your next game.'

UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Setting up and maintaining the grounds is tough work...',`Text1_0_loc9`='It hurts when I move my arm.',`Text1_1_loc9`='It hurts when I move my arm.' WHERE `entry`=18288;
UPDATE `locales_npc_text` SET ,`Text2_1_loc9`='This gash just doesn\'t seem to be healing.',`Text3_0_loc9`='That\'s the last time I try to set up the cannon alone...',`Text3_1_loc9`='That\'s the last time I try to set up the cannon alone...' WHERE `entry`=18288;
,`Text0_1_loc9`='We\'ve got hammers, we\'ve got gnolls.$B$BIf you\'ve got a token, you can use the hammer to whack some gnolls.'
,`Text0_1_loc9`='Looking for the old steam tonks?$B$BWell, we\'ve got some new ones for you to enjoy.$B$BNormally, it would cost two tokens to use a tonk remote. But because of your military service, you get a discounted rate of one token.$B$BWe at the Darkmoon Faire thank you for your service.'





,`Text0_1_loc9`='The naga are pumping all of the water away for their own use, and entire species are dying out as a result.$B$BIf we don\'t do something soon, what life is left on this dying world will disappear forever.'
...
,`Text0_1_loc9`='The dead do not belong in this realm.$B$BWhy, then, do we continually seek them out after putting them to rest?'

,`Text0_1_loc9`='The spirits here have been tormented for a long time. We only want to rest.'



,`Text0_1_loc9`='Warlord Kalithresh will fall!'
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='No more games for you.',`Text1_0_loc9`='Whaddya want now?',`Text1_1_loc9`='Whaddya want now?' WHERE `entry`=18317;
,`Text2_1_loc9`='Step aside and let some others have a chance to play.'

,`Text0_1_loc9`='How can I help you?'
UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=18321;
UPDATE `locales_npc_text` SET `Text0_1_loc9`='' WHERE `entry`=18322;
,`Text0_1_loc9`='How can I help you?'

,`Text0_1_loc9`='We people of the Lower City had a rather extensive spy network set up in the Shadow Labyrinth until recently.$B$BNow they\'re all dead except me and To\'gun.'





,`Text0_1_loc9`='You need Darkmoon Game Tokens to play.$B$BBuy them from any of the faire\'s Game Token vendors.$B$BI\'ll mark one on your map for you.'

,`Text0_1_loc9`='Hello and welcome to the Darkmoon Faire Staging Area.$B$BThe portal here will take you to the Darkmoon Faire.$B$BBut if you have any questions before you go, I can answer them.'
,`Text0_1_loc9`='The Darkmoon Faire is filled with all sorts of amazing attractions. We have a fortune teller, a concert, a fishing contest and a lot of games.$B$BWe are constantly expanding the faire with all manner of new attractions!$B$BAre there any attractions you\'d like more information on?'
,`Text0_1_loc9`='Miniature tanks, or Tonks as we\'ve cleverly named them, have been a faire favorite for as long as I can remember.$B$BWe have two arenas dedicated for tonk battles.$B$BOne arena pits you against the clock as you race to destroy targets, and avoid the enemy tonks. You just need a game token to play!$B$BThe other arena is a place where you can use your own tonks or MiniZeps to battle your friends.'
,`Text0_1_loc9`='The Blastenheimer 5000 Ultra Cannon is a state-of-the-art single person projectile device.$B$BDelivering its payload at near the speed of a dragon, the cannon is the pride and joy of the Blastenheimer family, world renowned for their aeronautical and combustible feats!$B$BIf you\'d like to be launched through the skies to fly free as a bird, seek out Maxima Blastenheimer.'
,`Text0_1_loc9`='Whack-a-Gnoll is a fun-filled game of whacking... gnolls.$B$BIt\'s a new attraction, and quite popular among us... Well, Sayge isn\'t too fond of it.'
,`Text0_1_loc9`='We like to make sure that faire goers of all ages can enjoy the games.$B$BRing Toss is a simple game where you try to land a ring on the back of a moving turtle.$B$BIt\'s one of my favorite games to play.'
,`Text0_1_loc9`='Rinling runs the shooting gallery.$B$BThere are only three targets to hit, and the faster you are, the better you do.$B$BPersonally, it\'s one of my favorite games.'
,`Text0_1_loc9`='I highly recommend that you visit Sayge to get your fortune told.$B$BI know, I know... he\'s a gnoll. But he\'s a very special gnoll with the power to divine your future!'
,`Text0_1_loc9`='Hello $C, and welcome to the Darkmoon Faire.$B$BThere is so much to do here at the faire that it can be a little overwhelming for our first time visitors. That\'s why I\'m here to help.$B$BDo you have any questions?'


,`Text0_1_loc9`='This set up sure is hard work.'
,`Text0_1_loc9`='I\'m sorry, but Lorna\'d be real mad if I let you take a horse.$B$BThey\'re only for those who are exalted with Gilneas!'
,`Text0_1_loc9`='Lorna said a truly brave adventurer helped rescue many of the horses near her family\'s orchard.$B$BI offered to take care of those that made it across the sea with us. I learned how from my mother and father, Light bless them!$B$BWere you interested in a fine Gilnean steed...?'
,`Text0_1_loc9`='Mysteries and wonders surround us every day, not just at the faire. We\'ve compiled a list of some of the wonders you may encounter in your every day business. The Darkmoon Adventurer\'s Guide will help you navigate the wonders of the world.$B$BWith the guide in your possession, you may come across items you never knew existed. Items you may have taken for granted in the past are now treasures that others long for.$B$BKeep the guide with you, and keep your eyes open for mystery.$B$BIf you happen to lose your guide, seek us out and we will replace it for free.'

,`Text0_1_loc9`='The Darkmoon Faire is now open!$B$BFor a small fee, I can teleport you to the fairground staging area.$B$BWould you like to go?'


,`Text0_1_loc9`='This is a very unusual place.$B$BThe magic I\'m channeling to try to repair the ley lines should be tearing my body apart, but I feel incredible!'



,`Text0_1_loc9`='The Scourge spread so rapidly, I often find myself wondering why they haven\'t already won this war.'
,`Text0_1_loc9`='<Corastrasza steps between you and the nearby corpse, her face wrinkled with concern.>$B$BI\'m sorry, $N. This is a private matter for the red flight to resolve.$B$BPlease see if you can help the others outside.'



UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='We waiting for tour guide.',`Text1_0_loc9`='Tour guide taking forever...',`Text1_1_loc9`='Tour guide taking forever...' WHERE `entry`=18559;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='We just wait for guide.',`Text1_0_loc9`='We hope guide gets here soon.',`Text1_1_loc9`='We hope guide gets here soon.' WHERE `entry`=18560;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='Are you here to lead the tour?',`Text1_0_loc9`='Are you my tour guide?',`Text1_1_loc9`='Are you my tour guide?' WHERE `entry`=18562;
UPDATE `locales_npc_text` SET ,`Text0_1_loc9`='If you are not here to lead a tour, leave us.',`Text1_0_loc9`='Are you here to lead a tour or gawk at us?  Be gone.',`Text1_1_loc9`='Are you here to lead a tour or gawk at us?  Be gone.' WHERE `entry`=18563;
...
,`Text0_1_loc9`='Select your destination.'
...
,`Text0_1_loc9`='Greetings, $N.'
,`Text0_1_loc9`='How can I be of aid, stranger?'
...
,`Text0_1_loc9`='Yes, hero?'
,`Text0_1_loc9`='Don\'t stop now.$B$BYou still have time left to play!'

,`Text0_1_loc9`='I can show you the aftermath of Deathwing\'s destruction at the Maelstrom, if you wish.'


,`Text0_1_loc9`='This cannot be, is it finally over?  I must be dreaming again.'

,`Text0_1_loc9`='Now you must usher in a new age... The age of mortals.'


,`Text0_1_loc9`='You may unlearn your current Class SPecialization for a price, so that you may select a new one.$B$BThis will become more expensive each additional time you do so.'
,`Text0_1_loc9`='You may unlearn all of your current Talents for a price, so that you may select a new ones.$B$BThis will become more expensive each additional time you do so.'
,`Text0_1_loc9`='You may empty all of your current Glyph slots for a price, so that you may select a new ones.$B$BThis will become more expensive each additional time you do so.'
,`Text0_1_loc9`='At level 10 you will choose a Class Specialization.$B$BIf you later decide to choose a different Class Specialization, you may reset your previous choice here for a price.$B$BThis will become more expensive each additional time you do so.'
,`Text0_1_loc9`='At level 15 you will choose your first Talent.$B$BIf you later decide to choose different Talents, you may reset your previous choices here for a price.$B$BThis will become more expensive each additional time you do so.'
,`Text0_1_loc9`='At level 25 you will begin to use Glyphs.$B$BIf you later decide to replace your chosen Glyphs, you may reset them here for a price.$B$BThis will become more expensive each additional time you do so.'
,`Text0_1_loc9`='At level 30 you can learn Dual Specialization, which allows you to keep two active Class Specialization, Talent, and Glyph sets and easily switch between them.$B$BYou also will have seperate glyph panes and action bars for each set.$B$BSwitching between the two sets cannot be done while in combat and will consume your available resources.'

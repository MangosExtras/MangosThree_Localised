...
UPDATE `trans_words` SET `content_loc3`='English Missing: 126954' WHERE `word_id` = 126954; -- locales_page_text - text : entry=3404
UPDATE `trans_words` SET `content_loc3`='English Missing: 126954' WHERE `word_id` = 126954; -- locales_page_text - text : entry=3405
UPDATE `trans_words` SET `content_loc3`='English Missing: 126954' WHERE `word_id` = 126954; -- locales_page_text - text : entry=3406
UPDATE `trans_words` SET `content_loc3`='English Missing: 126954' WHERE `word_id` = 126954; -- locales_page_text - text : entry=3407
UPDATE `trans_words` SET `content_loc3`='English Missing: 126954' WHERE `word_id` = 126954; -- locales_page_text - text : entry=3408

...
UPDATE `script_texts` SET `content_loc3`='Hogger nicht wehtun!' WHERE `entry`=-1004002;
...
UPDATE `script_texts` SET `content_loc3`='Unmöglich! Haltet ein, Sterbliche... Ich gebe auf! Ich gebe auf!' WHERE `entry`=-1409007;
...
UPDATE `script_texts` SET `content_loc3`='NARR! IHR LASST ES ZU, DASS SICH DIESE INSEKTEN IM GEHEILIGTEN KERN HERUMTREIBEN? UND NUN FÜHRT IHR SIE AUCH NOCH IN MEINE HEIMSTÄTTE? IHR ENTTÄUSCHT MICH, EXEKUTUS! IN DER TAT WERDE ICH GERECHTIGKEIT WALTEN LASSEN!' WHERE `entry`=-1409011;
...
UPDATE `script_texts` SET `content_loc3`='Seid bereit, Wachen! Ich weiß nicht, wie viele Eindringlinge es sind, doch die Mark ist überrannt und wir sind von den Hafenstädten abgeschnitten. Rechnet damit, in der Unterzahl zu sein.' WHERE `entry`=-1654003;
UPDATE `script_texts` SET `content_loc3`='Vernichtet diese stinkenden Bestien!' WHERE `entry`=-1654005;
UPDATE `script_texts` SET `content_loc3`='Schützt die Zivilisten!' WHERE `entry`=-1654006;
UPDATE `script_texts` SET `content_loc3`='Drängt sie zurück!' WHERE `entry`=-1654007;
UPDATE `script_texts` SET `content_loc3`='Beschützt mich, bitte!' WHERE `entry`=-1654009;
UPDATE `script_texts` SET `content_loc3`='Er kommt direkt auf mich zu!' WHERE `entry`=-1654010;
UPDATE `script_texts` SET `content_loc3`='Was um alles in der Welt...? Lasst uns von hier verschwinden!' WHERE `entry`=-1654011;
UPDATE `script_texts` SET `content_loc3`='Hilfe!' WHERE `entry`=-1654012;
UPDATE `script_texts` SET `content_loc3`='Helft mir, bitte!' WHERE `entry`=-1654013;
UPDATE `script_texts` SET `content_loc3`='Flüchtet! Sie sind überall!' WHERE `entry`=-1654015;
